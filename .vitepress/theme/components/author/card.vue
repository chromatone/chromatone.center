...
<template lang="pug">
.rounded-2xl.author-card.m-4.overflow-hidden(v-if="author" :i="i" :total="total" :height="8")
  .flex.flex-wrap.items-center.p-4
    img.avatar.min-h-10.overflow-hidden(:src="author.avatar")
