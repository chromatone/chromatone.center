...
.line {
  @apply m-1 shadow-md flex flex-col gap-4 rounded-2xl font-normal items-center px-4 py-2 transition-all bg-gray-50 dark_bg-gray-800 hover_(no-underline shadow-lg);
}
</style>