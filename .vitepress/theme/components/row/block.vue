...
<style scoped>
.row {
  @apply bg-light-500 w-full border-4 dark:bg-dark-500 flex flex-col transition no-underline rounded-4xl overflow-hidden shadow-lg;
  flex: 1 1 200px;
  &:hover {
...
.info {
  @apply m-2 relative max-w-500px flex self-stretch flex-wrap items-center p-4 md:(px-8 py-4) bg-light-100 dark:bg-dark-100 rounded-3xl;
}
