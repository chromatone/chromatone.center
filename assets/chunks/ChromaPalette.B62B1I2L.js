import{an as F,r as m,c as a,av as O,aQ as j,aR as q,$ as i,P as B,f as s,g,k as K,l as h,h as M,q as N,z as P,A as v,R as t}from"./framework.DBqT_UJK.js";import{ax as R,T as W}from"./theme.DVRQnRLg.js";const E=`// precision highp float;
...
`);return(n,e)=>{const o=i("gl-float"),r=i("gl-mat4"),l=i("gl-image"),f=i("gl-program"),k=i("gl-canvas"),A=B("tooltip");return s(),g("div",V,[d.value?N("",!0):K((s(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=$=>{h(y)(),d.value=!0})},e[1]||(e[1]=[M("div",{class:"i-la-microphone"},null,-1)]))),[[A,"Enable audio input"]]),(s(),P(k,{onUpdate:L,key:h(T)},{default:v(()=>[t(f,{name:"buffer0",code:x.value},{default:v(()=>[t(o,{name:"u_light",value:p.value},null,8,["value"]),t(r,{name:"u_notes",value:D.value},null,8,["value"]),t(l,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),t(f,{name:"main",code:z.value},{default:v(()=>[t(l,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{G as default};
