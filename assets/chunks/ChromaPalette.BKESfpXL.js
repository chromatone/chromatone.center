import{an as F,r as m,c as i,ax as O,aT as j,aU as N,a2 as r,W as B,v,x as g,B as M,D as h,H as W,M as K,N as p,X as a,z as q}from"./framework.C3BURm3f.js";import{au as E,S as P}from"./theme.CWHaFdN0.js";const R=`// precision highp float;
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),f=r("gl-program"),k=r("gl-canvas"),A=B("tooltip");return v(),g("div",U,[u.value?W("",!0):M((v(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=X=>{h(y)(),u.value=!0})},H)),[[A,"Enable audio input"]]),(v(),K(k,{onUpdate:S,key:h(T)},{default:p(()=>[a(f,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(f,{name:"main",code:z.value},{default:p(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{J as default};
