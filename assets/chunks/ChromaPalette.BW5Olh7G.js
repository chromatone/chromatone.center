import{ak as O,r as m,G as a,aJ as F,aO as j,aP as N,i,a0 as P,q as g,f as s,R as q,t as B,e as K,u as h,s as M,j as v,l as t}from"./framework.D01lOa8K.js";import{aP as W,N as E}from"./theme.CwHwVffe.js";const R=`// precision highp float;
...
`);return(n,e)=>{const o=i("gl-float"),r=i("gl-mat4"),l=i("gl-image"),f=i("gl-program"),k=i("gl-canvas"),A=P("tooltip");return s(),g("div",V,[d.value?B("",!0):q((s(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=G=>{h(y)(),d.value=!0})},e[1]||(e[1]=[M("div",{class:"i-la-microphone"},null,-1)]))),[[A,"Enable audio input"]]),(s(),K(k,{onUpdate:L,key:h(T)},{default:v(()=>[t(f,{name:"buffer0",code:x.value},{default:v(()=>[t(o,{name:"u_light",value:p.value},null,8,["value"]),t(r,{name:"u_notes",value:D.value},null,8,["value"]),t(l,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),t(f,{name:"main",code:z.value},{default:v(()=>[t(l,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{$ as default};
