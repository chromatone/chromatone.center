import{ao as F,r as m,c as i,av as O,aQ as j,aR as B,a2 as r,U as N,f as v,g,k as q,l as h,q as K,B as M,C as p,V as a,h as W}from"./framework.B7TlvOs3.js";import{ay as E,T as P}from"./theme.B5E67p0g.js";const R=`// precision highp float;
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),f=r("gl-program"),k=r("gl-canvas"),A=N("tooltip");return v(),g("div",V,[u.value?K("",!0):q((v(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=$=>{h(y)(),u.value=!0})},I)),[[A,"Enable audio input"]]),(v(),M(k,{onUpdate:L,key:h(T)},{default:p(()=>[a(f,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(f,{name:"main",code:z.value},{default:p(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{J as default};
