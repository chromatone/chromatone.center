import{an as F,r as m,c as i,av as O,aQ as j,aR as N,a1 as r,W as E,x as v,y as g,C as M,E as h,I as W,M as B,N as p,X as a,A as K}from"./framework.BVi3ytxD.js";import{aE as q,Z as P}from"./theme.DBGtJYKy.js";const R=`// precision highp float;
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),f=r("gl-program"),A=r("gl-canvas"),k=E("tooltip");return v(),g("div",V,[u.value?W("",!0):M((v(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=X=>{h(y)(),u.value=!0})},U)),[[k,"Enable audio input"]]),(v(),B(A,{onUpdate:L,key:h(T)},{default:p(()=>[a(f,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(f,{name:"main",code:z.value},{default:p(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{G as default};
