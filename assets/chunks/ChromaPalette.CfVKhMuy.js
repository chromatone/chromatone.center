import{ak as O,r as m,G as a,aJ as F,aO as j,aP as B,f as i,a0 as K,c as s,h as g,R as M,u as h,i as N,k as P,e as W,s as v,t}from"./framework.D_pKV3Tc.js";import{aQ as q,O as E}from"./theme.DF4Pw-XN.js";const R=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert h-screen",id:"screen"},Q={__name:"ChromaPalette",setup(U){const{tuner:c,init:y}=q(),{width:b,height:_}=O(),p=m(0),d=m(!1),{activeNotes:u}=E(),x=a(()=>R),C=a(()=>{let n=new Array(12).fill(0);for(let e in u.value){const o=(Number(e)-9)%12;n[o]+=u.value[e]}return n.map((e,o)=>{let r=Math.pow(c.aChroma[o],2),l=r>c.chromaAvg&&!c.note.silent?r:0;return e+l})}),w=F(C,{duration:200,transition:j.easeOutExpo}),D=a(()=>{const n=Array(16).fill(0);return w.value.forEach((e,o)=>n[o]=e),n});function L(n){p.value=(Math.sin(n.iTime)+1)/2}const S=a(()=>b.value||_.value?Math.random():0),T=B(S,100),z=a(()=>`
...
`);return(n,e)=>{const o=i("gl-float"),r=i("gl-mat4"),l=i("gl-image"),f=i("gl-program"),k=i("gl-canvas"),A=K("tooltip");return s(),g("div",V,[d.value?P("",!0):M((s(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=G=>{h(y)(),d.value=!0})},e[1]||(e[1]=[N("div",{class:"i-la-microphone"},null,-1)]))),[[A,"Enable audio input"]]),(s(),W(k,{onUpdate:L,key:h(T)},{default:v(()=>[t(f,{name:"buffer0",code:x.value},{default:v(()=>[t(o,{name:"u_light",value:p.value},null,8,["value"]),t(r,{name:"u_notes",value:D.value},null,8,["value"]),t(l,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),t(f,{name:"main",code:z.value},{default:v(()=>[t(l,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{Q as default};
