import{ao as F,r as m,c as i,av as O,aQ as j,aR as N,a2 as r,S as q,f as v,g,k as B,l as h,h as K,q as M,z as W,A as p,U as a}from"./framework.DqjO8Koj.js";import{ax as E,T as P}from"./theme.C1B78J4N.js";const R=`// precision highp float;
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),f=r("gl-program"),k=r("gl-canvas"),A=q("tooltip");return v(),g("div",U,[u.value?M("",!0):B((v(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=I=>{h(y)(),u.value=!0})},e[1]||(e[1]=[K("div",{class:"i-la-microphone"},null,-1)]))),[[A,"Enable audio input"]]),(v(),W(k,{onUpdate:S,key:h(T)},{default:p(()=>[a(f,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(f,{name:"main",code:z.value},{default:p(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{G as default};
