import{an as F,r as m,c as a,av as O,aQ as j,aR as M,$ as i,P as R,x as s,y as g,C as B,E as h,A as E,I as K,L as N,M as v,R as t}from"./framework.DzzWumix.js";import{ax as P,R as W}from"./theme.C7-omd-H.js";const q=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert h-screen",id:"screen"},G={__name:"ChromaPalette",setup(I){const{tuner:c,init:y}=P(),{width:b,height:_}=F(),p=m(0),d=m(!1),{activeNotes:u}=W(),x=a(()=>q),C=a(()=>{let n=new Array(12).fill(0);for(let e in u.value){const o=(Number(e)-9)%12;n[o]+=u.value[e]}return n.map((e,o)=>{let r=Math.pow(c.aChroma[o],2),l=r>c.chromaAvg&&!c.note.silent?r:0;return e+l})}),w=O(C,{duration:200,transition:j.easeOutExpo}),D=a(()=>{const n=Array(16).fill(0);return w.value.forEach((e,o)=>n[o]=e),n});function L(n){p.value=(Math.sin(n.iTime)+1)/2}const S=a(()=>b.value||_.value?Math.random():0),T=M(S,100),z=a(()=>`
...
`);return(n,e)=>{const o=i("gl-float"),r=i("gl-mat4"),l=i("gl-image"),f=i("gl-program"),A=i("gl-canvas"),k=R("tooltip");return s(),g("div",V,[d.value?K("",!0):B((s(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=U=>{h(y)(),d.value=!0})},e[1]||(e[1]=[E("div",{class:"i-la-microphone"},null,-1)]))),[[k,"Enable audio input"]]),(s(),N(A,{onUpdate:L,key:h(T)},{default:v(()=>[t(f,{name:"buffer0",code:x.value},{default:v(()=>[t(o,{name:"u_light",value:p.value},null,8,["value"]),t(r,{name:"u_notes",value:D.value},null,8,["value"]),t(l,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),t(f,{name:"main",code:z.value},{default:v(()=>[t(l,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{G as default};
