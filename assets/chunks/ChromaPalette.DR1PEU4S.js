import{an as F,r as m,c as a,av as O,aQ as j,aR as R,$ as i,P as q,f as s,g,k as B,l as h,h as K,q as M,z as N,A as v,R as t}from"./framework.CTevW8ou.js";import{ax as P,R as W}from"./theme.D9gdeZqv.js";const E=`// precision highp float;
...
`);return(n,e)=>{const o=i("gl-float"),r=i("gl-mat4"),l=i("gl-image"),f=i("gl-program"),k=i("gl-canvas"),A=q("tooltip");return s(),g("div",V,[d.value?M("",!0):B((s(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=$=>{h(y)(),d.value=!0})},e[1]||(e[1]=[K("div",{class:"i-la-microphone"},null,-1)]))),[[A,"Enable audio input"]]),(s(),N(k,{onUpdate:L,key:h(z)},{default:v(()=>[t(f,{name:"buffer0",code:x.value},{default:v(()=>[t(o,{name:"u_light",value:p.value},null,8,["value"]),t(r,{name:"u_notes",value:D.value},null,8,["value"]),t(l,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),t(f,{name:"main",code:T.value},{default:v(()=>[t(l,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{G as default};
