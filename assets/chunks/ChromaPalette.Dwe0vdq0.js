import{aX as F,R as O,H as j,a_ as M,a$ as q,ae as B}from"./theme.DcbTpn-S.js";import{i as a,a1 as K,q as m,f as s,Z as N,t as W,e as E,r as g,u as h,s as P,j as v,l as t,M as i}from"./framework.Bd4nPCcm.js";const R=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert h-screen",id:"screen"},X={__name:"ChromaPalette",setup(U){const{tuner:c,init:y}=F(),{width:b,height:_}=B(),p=g(0),d=g(!1),{activeNotes:u}=O(),x=i(()=>R),C=i(()=>{let n=new Array(12).fill(0);for(let e in u.value){const o=(Number(e)-9)%12;n[o]+=u.value[e]}return n.map((e,o)=>{let r=Math.pow(c.aChroma[o],2),l=r>c.chromaAvg&&!c.note.silent?r:0;return e+l})}),w=j(C,{duration:200,transition:M.easeOutExpo}),D=i(()=>{const n=Array(16).fill(0);return w.value.forEach((e,o)=>n[o]=e),n});function L(n){p.value=(Math.sin(n.iTime)+1)/2}const S=i(()=>b.value||_.value?Math.random():0),T=q(S,100),z=i(()=>`
...
`);return(n,e)=>{const o=a("gl-float"),r=a("gl-mat4"),l=a("gl-image"),f=a("gl-program"),k=a("gl-canvas"),A=K("tooltip");return s(),m("div",V,[d.value?W("",!0):N((s(),m("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=$=>{h(y)(),d.value=!0})},[...e[1]||(e[1]=[P("div",{class:"i-la-microphone"},null,-1)])])),[[A,"Enable audio input"]]),(s(),E(k,{onUpdate:L,key:h(T)},{default:v(()=>[t(f,{name:"buffer0",code:x.value},{default:v(()=>[t(o,{name:"u_light",value:p.value},null,8,["value"]),t(r,{name:"u_notes",value:D.value},null,8,["value"]),t(l,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),t(f,{name:"main",code:z.value},{default:v(()=>[t(l,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{X as default};
