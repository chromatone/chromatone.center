import{an as F,r as m,c as i,ay as O,aC as j,aZ as N,a6 as r,Y as K,C as v,D as g,I as B,K as h,N as M,R as W,S as p,a0 as a,F as q}from"./framework.D0WAkjk4.js";import{H as E,u as P}from"./theme.CjOXjCIt.js";const R=`// precision highp float;
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),f=r("gl-program"),k=r("gl-canvas"),A=K("tooltip");return v(),g("div",V,[u.value?M("",!0):B((v(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=Y=>{h(y)(),u.value=!0})},U)),[[A,"Enable audio input"]]),(v(),W(k,{onUpdate:S,key:h(T)},{default:p(()=>[a(f,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(f,{name:"main",code:z.value},{default:p(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{G as default};
