import{aC as O,ag as F,X as j,L as B,b2 as N,b3 as K}from"./theme.C1cSeBFq.js";import{a as m,d as i,Y as r,O as M,v,x as g,B as W,u as h,z as q,G as E,I as P,J as p,Q as a}from"./framework.BMHKg3V0.js";const R=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert h-screen",id:"screen"},Q={__name:"ChromaPalette",setup(I){const{tuner:s,init:y}=O(),{width:b,height:_}=F(),d=m(0),u=m(!1),{midi:t}=j(),x=i(()=>R),C=i(()=>{let n=new Array(12).fill(0);for(let e in t==null?void 0:t.activeNotes){const o=(Number(e)-9)%12;n[o]+=t==null?void 0:t.activeNotes[e]}return n.map((e,o)=>{let l=Math.pow(s.aChroma[o],2),c=l>s.chromaAvg&&!s.note.silent?l:0;return e+c})}),w=B(C,{duration:200,transition:N.easeOutExpo}),D=i(()=>{const n=Array(16).fill(0);return w.value.forEach((e,o)=>n[o]=e),n});function L(n){d.value=(Math.sin(n.iTime)+1)/2}const S=i(()=>b.value||_.value?Math.random():0),z=K(S,100),T=i(()=>`
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),f=r("gl-program"),k=r("gl-canvas"),A=M("tooltip");return v(),g("div",V,[u.value?E("",!0):W((v(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=U=>{h(y)(),u.value=!0})},e[1]||(e[1]=[q("div",{class:"i-la-microphone"},null,-1)]))),[[A,"Enable audio input"]]),(v(),P(k,{onUpdate:L,key:h(z)},{default:p(()=>[a(f,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(f,{name:"main",code:T.value},{default:p(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{Q as default};
