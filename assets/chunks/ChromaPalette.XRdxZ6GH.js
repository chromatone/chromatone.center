import{an as F,r as m,c as i,au as O,aP as j,aQ as N,a1 as r,W as M,x as v,y as g,C as W,E as h,I as B,M as E,N as p,X as a,A as K}from"./framework.Bi_5INRF.js";import{aD as P,Y as q}from"./theme.dQYKTFz5.js";const R=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert h-screen",id:"screen"},I=K("div",{class:"i-la-microphone"},null,-1),U=[I],G={__name:"ChromaPalette",setup(Q){const{tuner:s,init:y}=P(),{width:b,height:_}=F(),d=m(0),u=m(!1),{midi:t}=q(),x=i(()=>R),C=i(()=>{let n=new Array(12).fill(0);for(let e in t==null?void 0:t.activeNotes){const o=(Number(e)-9)%12;n[o]+=t==null?void 0:t.activeNotes[e]}return n.map((e,o)=>{let l=Math.pow(s.aChroma[o],2),c=l>s.chromaAvg&&!s.note.silent?l:0;return e+c})}),w=O(C,{duration:200,transition:j.easeOutExpo}),D=i(()=>{const n=Array(16).fill(0);return w.value.forEach((e,o)=>n[o]=e),n});function L(n){d.value=(Math.sin(n.iTime)+1)/2}const S=i(()=>b.value||_.value?Math.random():0),T=N(S,100),z=i(()=>`
