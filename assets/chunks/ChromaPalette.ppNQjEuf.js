import{an as F,r as m,c as a,av as O,aQ as j,aR as M,$ as i,M as N,x as s,y as g,C as W,E as h,A as B,I as E,T as K,U as v,P as t}from"./framework.Bh6q1hI4.js";import{aW as P,N as q}from"./theme.DIa4sgO1.js";const R=`// precision highp float;
...
`);return(n,e)=>{const o=i("gl-float"),r=i("gl-mat4"),l=i("gl-image"),f=i("gl-program"),A=i("gl-canvas"),k=N("tooltip");return s(),g("div",U,[d.value?E("",!0):W((s(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=I=>{h(y)(),d.value=!0})},e[1]||(e[1]=[B("div",{class:"i-la-microphone"},null,-1)]))),[[k,"Enable audio input"]]),(s(),K(A,{onUpdate:L,key:h(T)},{default:v(()=>[t(f,{name:"buffer0",code:x.value},{default:v(()=>[t(o,{name:"u_light",value:p.value},null,8,["value"]),t(r,{name:"u_notes",value:D.value},null,8,["value"]),t(l,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),t(f,{name:"main",code:z.value},{default:v(()=>[t(l,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{G as default};
