import{an as A,r as g,c as l,ax as O,aT as j,aU as B,a2 as c,W as M,v as p,x as y,B as N,D as b,H as W,M as K,N as s,X as e,z as q}from"./framework.C3BURm3f.js";import{au as E,S as R}from"./theme.CLnLGAIL.js";const P=`// precision highp float;
...
}`,U={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},V=q("div",{class:"i-la-microphone"},null,-1),G=[V],J={__name:"ChromaPaletteFeedback",setup(H){const{tuner:u,init:_}=E(),{width:x,height:C}=A(),v=g(0),f=g(!1),{midi:a}=R(),m=l(()=>P),w=l(()=>{let t=new Array(12).fill(0);for(let n in a==null?void 0:a.activeNotes){const o=(Number(n)-9)%12;t[o]+=a==null?void 0:a.activeNotes[n]}return t.map((n,o)=>{let r=Math.pow(u.aChroma[o],2),i=r>Math.pow(u.chromaAvg,2)&&!u.note.silent?r:0;return n+i})}),D=O(w,{duration:200,transition:j.easeOutExpo}),h=l(()=>{const t=Array(16).fill(0);return D.value.forEach((n,o)=>t[o]=n),t});function S(t){v.value=(Math.sin(t.iTime)+1)/2}const L=l(()=>x.value||C.value?Math.random():0),T=B(L,100),z=l(()=>`
...
`);return(t,n)=>{const o=c("gl-float"),r=c("gl-mat4"),i=c("gl-image"),d=c("gl-program"),F=c("gl-canvas"),k=M("tooltip");return p(),y("div",U,[f.value?W("",!0):N((p(),y("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:n[0]||(n[0]=I=>{b(_)(),f.value=!0})},G)),[[k,"Enable audio input"]]),(p(),K(F,{onUpdate:S,key:b(T)},{default:s(()=>[e(d,{name:"buffer0",code:m.value},{default:s(()=>[e(o,{name:"u_light",value:v.value},null,8,["value"]),e(r,{name:"u_notes",value:h.value},null,8,["value"]),e(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),e(d,{name:"buffer1",code:m.value},{default:s(()=>[e(o,{name:"u_light",value:v.value},null,8,["value"]),e(r,{name:"u_notes",value:h.value},null,8,["value"]),e(i,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),e(d,{name:"main",code:z.value},{default:s(()=>[e(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}};export{J as default};
