import{an as z,r as g,c as r,av as O,aQ as j,aR as M,$ as l,M as B,x as d,y,C as N,E as b,A as E,I as K,T as R,U as c,P as n}from"./framework.BjEhsXnI.js";import{at as W,N as q}from"./theme.Bl9EEmmj.js";const P=`// precision highp float;
...
`);return(t,e)=>{const o=l("gl-float"),a=l("gl-mat4"),i=l("gl-image"),v=l("gl-program"),F=l("gl-canvas"),k=B("tooltip");return d(),y("div",U,[p.value?K("",!0):N((d(),y("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=I=>{b(_)(),p.value=!0})},e[1]||(e[1]=[E("div",{class:"i-la-microphone"},null,-1)]))),[[k,"Enable audio input"]]),(d(),R(F,{onUpdate:S,key:b(T)},{default:c(()=>[n(v,{name:"buffer0",code:m.value},{default:c(()=>[n(o,{name:"u_light",value:u.value},null,8,["value"]),n(a,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),n(v,{name:"buffer1",code:m.value},{default:c(()=>[n(o,{name:"u_light",value:u.value},null,8,["value"]),n(a,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),n(v,{name:"main",code:A.value},{default:c(()=>[n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}};export{Q as default};
