import{ak as A,r as g,G as r,aJ as O,aO as j,aP as B,f as l,a0 as M,c as d,h as y,R as N,u as b,i as K,k as P,e as R,s as c,t as n}from"./framework.DqGUeSFU.js";import{aP as W,N as q}from"./theme.DkSlrVce.js";const E=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},$={__name:"ChromaPaletteFeedback",setup(G){const{tuner:s,init:_}=W(),{width:x,height:C}=A(),u=g(0),p=g(!1),{activeNotes:f}=q(),m=r(()=>E),w=r(()=>{let t=new Array(12).fill(0);for(let e in f.value){const o=(Number(e)-9)%12;t[o]+=f.value[e]}return t.map((e,o)=>{let a=Math.pow(s.aChroma[o],2),i=a>Math.pow(s.chromaAvg,2)&&!s.note.silent?a:0;return e+i})}),D=O(w,{duration:200,transition:j.easeOutExpo}),h=r(()=>{const t=Array(16).fill(0);return D.value.forEach((e,o)=>t[o]=e),t});function S(t){u.value=(Math.sin(t.iTime)+1)/2}const L=r(()=>x.value||C.value?Math.random():0),k=B(L,100),F=r(()=>`
