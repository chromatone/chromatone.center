import{an as z,r as g,c as r,av as O,aQ as j,aR as M,$ as l,P as R,x as d,y,C as B,E as b,A as E,I as K,L as N,M as c,R as n}from"./framework.DzzWumix.js";import{ax as W,R as q}from"./theme.CASTdkoz.js";const P=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},Q={__name:"ChromaPaletteFeedback",setup(I){const{tuner:s,init:_}=W(),{width:x,height:C}=z(),u=g(0),p=g(!1),{activeNotes:f}=q(),m=r(()=>P),w=r(()=>{let t=new Array(12).fill(0);for(let e in f.value){const o=(Number(e)-9)%12;t[o]+=f.value[e]}return t.map((e,o)=>{let a=Math.pow(s.aChroma[o],2),i=a>Math.pow(s.chromaAvg,2)&&!s.note.silent?a:0;return e+i})}),D=O(w,{duration:200,transition:j.easeOutExpo}),h=r(()=>{const t=Array(16).fill(0);return D.value.forEach((e,o)=>t[o]=e),t});function L(t){u.value=(Math.sin(t.iTime)+1)/2}const S=r(()=>x.value||C.value?Math.random():0),A=M(S,100),F=r(()=>`
...
`);return(t,e)=>{const o=l("gl-float"),a=l("gl-mat4"),i=l("gl-image"),v=l("gl-program"),T=l("gl-canvas"),k=R("tooltip");return d(),y("div",V,[p.value?K("",!0):B((d(),y("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=U=>{b(_)(),p.value=!0})},e[1]||(e[1]=[E("div",{class:"i-la-microphone"},null,-1)]))),[[k,"Enable audio input"]]),(d(),N(T,{onUpdate:L,key:b(A)},{default:c(()=>[n(v,{name:"buffer0",code:m.value},{default:c(()=>[n(o,{name:"u_light",value:u.value},null,8,["value"]),n(a,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),n(v,{name:"buffer1",code:m.value},{default:c(()=>[n(o,{name:"u_light",value:u.value},null,8,["value"]),n(a,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),n(v,{name:"main",code:F.value},{default:c(()=>[n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}};export{Q as default};
