import{ao as F,r as g,c as l,av as O,aQ as j,aR as B,a2 as c,S as M,f as p,g as y,k as N,l as b,h as q,q as K,z as R,A as s,U as n}from"./framework.CRnXhBxo.js";import{ax as W,T as E}from"./theme.Bq_9bLhe.js";const P=`// precision highp float;
...
}`,U={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},$={__name:"ChromaPaletteFeedback",setup(V){const{tuner:u,init:_}=W(),{width:x,height:C}=F(),v=g(0),f=g(!1),{midi:a}=E(),m=l(()=>P),w=l(()=>{let t=new Array(12).fill(0);for(let e in a==null?void 0:a.activeNotes){const o=(Number(e)-9)%12;t[o]+=a==null?void 0:a.activeNotes[e]}return t.map((e,o)=>{let r=Math.pow(u.aChroma[o],2),i=r>Math.pow(u.chromaAvg,2)&&!u.note.silent?r:0;return e+i})}),D=O(w,{duration:200,transition:j.easeOutExpo}),h=l(()=>{const t=Array(16).fill(0);return D.value.forEach((e,o)=>t[o]=e),t});function S(t){v.value=(Math.sin(t.iTime)+1)/2}const L=l(()=>x.value||C.value?Math.random():0),T=B(L,100),k=l(()=>`
...
`);return(t,e)=>{const o=c("gl-float"),r=c("gl-mat4"),i=c("gl-image"),d=c("gl-program"),z=c("gl-canvas"),A=M("tooltip");return p(),y("div",U,[f.value?K("",!0):N((p(),y("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=G=>{b(_)(),f.value=!0})},e[1]||(e[1]=[q("div",{class:"i-la-microphone"},null,-1)]))),[[A,"Enable audio input"]]),(p(),R(z,{onUpdate:S,key:b(T)},{default:s(()=>[n(d,{name:"buffer0",code:m.value},{default:s(()=>[n(o,{name:"u_light",value:v.value},null,8,["value"]),n(r,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),n(d,{name:"buffer1",code:m.value},{default:s(()=>[n(o,{name:"u_light",value:v.value},null,8,["value"]),n(r,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),n(d,{name:"main",code:k.value},{default:s(()=>[n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}};export{$ as default};
