import{At as e,F as t,M as n,N as r,P as i,R as a,St as o,at as s,dt as c,et as l,ft as u,j as d,ot as f}from"./framework.Bs4wm_X5.js";import{In as p,Ln as m,Rn as h,_n as g,g as _,zt as v}from"./theme.DtloWbYQ.js";var y=`// precision highp float;
...
}`,b={class:`relative rounded-lg overflow-hidden pointer-events-auto touch-revert`,id:`screen`},x={__name:`ChromaPaletteFeedback`,setup(x){let{tuner:S,init:C}=_(),{width:w,height:T}=m(),E=o(0),D=o(!1),{activeNotes:O}=v(),k=d(()=>y),A=d(()=>{let e=Array(12).fill(0);for(let t in O.value){let n=(Number(t)-9)%12;e[n]+=O.value[t]}return e.map((e,t)=>{let n=S.aChroma[t]**2;return e+(n>S.chromaAvg**2&&!S.note.silent?n:0)})}),j=p(A,{duration:200,transition:g.easeOutExpo}),M=d(()=>{let e=Array(16).fill(0);return j.value.forEach((t,n)=>e[n]=t),e});function N(e){E.value=(Math.sin(e.iTime)+1)/2}let P=d(()=>w.value||T.value?Math.random():0),F=h(P,100),I=d(()=>`
...
`);return(o,d)=>{let p=s(`gl-float`),m=s(`gl-mat4`),h=s(`gl-image`),g=s(`gl-program`),_=s(`gl-canvas`),v=f(`tooltip`);return l(),t(`div`,b,[D.value?i(``,!0):u((l(),t(`button`,{key:0,class:`absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition`,onClick:d[0]||=t=>{e(C)(),D.value=!0}},[...d[1]||=[n(`div`,{class:`i-la-microphone`},null,-1)]])),[[v,`Enable audio input`]]),(l(),r(_,{onUpdate:N,key:e(F)},{default:c(()=>[a(g,{name:`buffer0`,code:k.value},{default:c(()=>[a(p,{name:`u_light`,value:E.value},null,8,[`value`]),a(m,{name:`u_notes`,value:M.value},null,8,[`value`]),a(h,{name:`u_mainOutput`,value:`buffer1`})]),_:1},8,[`code`]),a(g,{name:`buffer1`,code:k.value},{default:c(()=>[a(p,{name:`u_light`,value:E.value},null,8,[`value`]),a(m,{name:`u_notes`,value:M.value},null,8,[`value`]),a(h,{name:`u_mainOutput`,value:`buffer0`})]),_:1},8,[`code`]),a(g,{name:`main`,code:I.value},{default:c(()=>[a(h,{name:`u_mainOutput`,value:`buffer1`})]),_:1},8,[`code`])]),_:1}))])}}};export{x as default};