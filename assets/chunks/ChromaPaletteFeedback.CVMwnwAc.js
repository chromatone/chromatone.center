import{am as A,r as g,c as l,av as O,aQ as j,aR as B,a1 as c,W as M,v as p,x as y,B as N,D as b,H as W,M as E,N as s,X as e,z as K}from"./framework.njvVDImA.js";import{aE as R,Z as q}from"./theme.DZiOYyfH.js";const P=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},U=K("div",{class:"i-la-microphone"},null,-1),G=[U],Z={__name:"ChromaPaletteFeedback",setup(H){const{tuner:u,init:_}=R(),{width:x,height:C}=A(),v=g(0),f=g(!1),{midi:a}=q(),m=l(()=>P),w=l(()=>{let t=new Array(12).fill(0);for(let n in a==null?void 0:a.activeNotes){const o=(Number(n)-9)%12;t[o]+=a==null?void 0:a.activeNotes[n]}return t.map((n,o)=>{let r=Math.pow(u.aChroma[o],2),i=r>Math.pow(u.chromaAvg,2)&&!u.note.silent?r:0;return n+i})}),D=O(w,{duration:200,transition:j.easeOutExpo}),h=l(()=>{const t=Array(16).fill(0);return D.value.forEach((n,o)=>t[o]=n),t});function S(t){v.value=(Math.sin(t.iTime)+1)/2}const L=l(()=>x.value||C.value?Math.random():0),z=B(L,100),F=l(()=>`
...
`);return(t,n)=>{const o=c("gl-float"),r=c("gl-mat4"),i=c("gl-image"),d=c("gl-program"),T=c("gl-canvas"),k=M("tooltip");return p(),y("div",V,[f.value?W("",!0):N((p(),y("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:n[0]||(n[0]=I=>{b(_)(),f.value=!0})},G)),[[k,"Enable audio input"]]),(p(),E(T,{onUpdate:S,key:b(z)},{default:s(()=>[e(d,{name:"buffer0",code:m.value},{default:s(()=>[e(o,{name:"u_light",value:v.value},null,8,["value"]),e(r,{name:"u_notes",value:h.value},null,8,["value"]),e(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),e(d,{name:"buffer1",code:m.value},{default:s(()=>[e(o,{name:"u_light",value:v.value},null,8,["value"]),e(r,{name:"u_notes",value:h.value},null,8,["value"]),e(i,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),e(d,{name:"main",code:F.value},{default:s(()=>[e(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}};export{Z as default};
