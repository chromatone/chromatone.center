import{an as z,r as g,c as l,au as O,aP as j,aQ as M,a1 as c,W as N,x as p,y,C as B,E as b,I as W,M as E,N as s,X as e,A as K}from"./framework.BY0U24KH.js";import{aD as q,Y as P}from"./theme.C7XPe3zW.js";const R=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},I=K("div",{class:"i-la-microphone"},null,-1),U=[I],$={__name:"ChromaPaletteFeedback",setup(G){const{tuner:u,init:_}=q(),{width:x,height:C}=z(),v=g(0),f=g(!1),{midi:a}=P(),m=l(()=>R),w=l(()=>{let t=new Array(12).fill(0);for(let n in a==null?void 0:a.activeNotes){const o=(Number(n)-9)%12;t[o]+=a==null?void 0:a.activeNotes[n]}return t.map((n,o)=>{let r=Math.pow(u.aChroma[o],2),i=r>Math.pow(u.chromaAvg,2)&&!u.note.silent?r:0;return n+i})}),D=O(w,{duration:200,transition:j.easeOutExpo}),h=l(()=>{const t=Array(16).fill(0);return D.value.forEach((n,o)=>t[o]=n),t});function S(t){v.value=(Math.sin(t.iTime)+1)/2}const L=l(()=>x.value||C.value?Math.random():0),A=M(L,100),F=l(()=>`
