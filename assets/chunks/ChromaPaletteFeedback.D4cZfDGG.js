import{an as T,r as g,c as r,av as O,aQ as j,aR as B,$ as l,P as M,f as d,g as y,k as R,l as b,h as q,q as K,z as N,A as c,R as n}from"./framework.DBqT_UJK.js";import{ax as W,Q as E}from"./theme.CDDm1v1U.js";const P=`// precision highp float;
...
`);return(t,e)=>{const o=l("gl-float"),a=l("gl-mat4"),i=l("gl-image"),v=l("gl-program"),A=l("gl-canvas"),F=M("tooltip");return d(),y("div",V,[p.value?K("",!0):R((d(),y("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=U=>{b(_)(),p.value=!0})},e[1]||(e[1]=[q("div",{class:"i-la-microphone"},null,-1)]))),[[F,"Enable audio input"]]),(d(),N(A,{onUpdate:S,key:b(k)},{default:c(()=>[n(v,{name:"buffer0",code:m.value},{default:c(()=>[n(o,{name:"u_light",value:u.value},null,8,["value"]),n(a,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),n(v,{name:"buffer1",code:m.value},{default:c(()=>[n(o,{name:"u_light",value:u.value},null,8,["value"]),n(a,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),n(v,{name:"main",code:z.value},{default:c(()=>[n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}};export{I as default};
