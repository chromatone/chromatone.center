import{aY as A,af as O,R as j,H as B,a$ as M,b0 as R}from"./theme.CeJemaUI.js";import{a as g,e as r,a0 as l,O as W,B as d,C as y,H as E,u as b,E as K,L as N,V as q,W as c,R as n}from"./framework.B_b_ZswS.js";const V=`// precision highp float;
...
}`,P={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},I={__name:"ChromaPaletteFeedback",setup(H){const{tuner:s,init:_}=A(),{width:x,height:C}=O(),u=g(0),p=g(!1),{activeNotes:f}=j(),m=r(()=>V),w=r(()=>{let t=new Array(12).fill(0);for(let e in f.value){const o=(Number(e)-9)%12;t[o]+=f.value[e]}return t.map((e,o)=>{let a=Math.pow(s.aChroma[o],2),i=a>Math.pow(s.chromaAvg,2)&&!s.note.silent?a:0;return e+i})}),D=B(w,{duration:200,transition:M.easeOutExpo}),h=r(()=>{const t=Array(16).fill(0);return D.value.forEach((e,o)=>t[o]=e),t});function L(t){u.value=(Math.sin(t.iTime)+1)/2}const S=r(()=>x.value||C.value?Math.random():0),F=R(S,100),T=r(()=>`
...
`);return(t,e)=>{const o=l("gl-float"),a=l("gl-mat4"),i=l("gl-image"),v=l("gl-program"),k=l("gl-canvas"),z=W("tooltip");return d(),y("div",P,[p.value?N("",!0):E((d(),y("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=U=>{b(_)(),p.value=!0})},e[1]||(e[1]=[K("div",{class:"i-la-microphone"},null,-1)]))),[[z,"Enable audio input"]]),(d(),q(k,{onUpdate:L,key:b(F)},{default:c(()=>[n(v,{name:"buffer0",code:m.value},{default:c(()=>[n(o,{name:"u_light",value:u.value},null,8,["value"]),n(a,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),n(v,{name:"buffer1",code:m.value},{default:c(()=>[n(o,{name:"u_light",value:u.value},null,8,["value"]),n(a,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),n(v,{name:"main",code:T.value},{default:c(()=>[n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}};export{I as default};
