import{aX as A,R as O,H as j,a_ as M,a$ as B,ae as q}from"./theme.W5xEI6lF.js";import{i as r,a1 as K,q as g,f as d,Z as N,t as R,e as W,r as y,u as b,s as E,j as c,l as n,M as l}from"./framework.B7eJj9Se.js";const P=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},I={__name:"ChromaPaletteFeedback",setup(U){const{tuner:s,init:_}=A(),{width:x,height:C}=q(),u=y(0),p=y(!1),{activeNotes:f}=O(),m=l(()=>P),w=l(()=>{let t=new Array(12).fill(0);for(let e in f.value){const o=(Number(e)-9)%12;t[o]+=f.value[e]}return t.map((e,o)=>{let a=Math.pow(s.aChroma[o],2),i=a>Math.pow(s.chromaAvg,2)&&!s.note.silent?a:0;return e+i})}),D=j(w,{duration:200,transition:M.easeOutExpo}),h=l(()=>{const t=Array(16).fill(0);return D.value.forEach((e,o)=>t[o]=e),t});function S(t){u.value=(Math.sin(t.iTime)+1)/2}const L=l(()=>x.value||C.value?Math.random():0),F=B(L,100),T=l(()=>`
