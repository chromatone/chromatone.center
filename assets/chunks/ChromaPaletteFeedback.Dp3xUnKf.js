import{aC as A,ag as O,X as j,L as B,b2 as M,b3 as N}from"./theme.C1cSeBFq.js";import{a as g,d as l,Y as c,O as K,v as p,x as y,B as W,u as b,z as q,G as E,I as R,J as s,Q as n}from"./framework.BMHKg3V0.js";const P=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},Q={__name:"ChromaPaletteFeedback",setup(G){const{tuner:u,init:_}=A(),{width:x,height:C}=O(),v=g(0),f=g(!1),{midi:a}=j(),m=l(()=>P),w=l(()=>{let t=new Array(12).fill(0);for(let e in a==null?void 0:a.activeNotes){const o=(Number(e)-9)%12;t[o]+=a==null?void 0:a.activeNotes[e]}return t.map((e,o)=>{let r=Math.pow(u.aChroma[o],2),i=r>Math.pow(u.chromaAvg,2)&&!u.note.silent?r:0;return e+i})}),D=B(w,{duration:200,transition:M.easeOutExpo}),h=l(()=>{const t=Array(16).fill(0);return D.value.forEach((e,o)=>t[o]=e),t});function L(t){v.value=(Math.sin(t.iTime)+1)/2}const S=l(()=>x.value||C.value?Math.random():0),z=N(S,100),F=l(()=>`
...
`);return(t,e)=>{const o=c("gl-float"),r=c("gl-mat4"),i=c("gl-image"),d=c("gl-program"),T=c("gl-canvas"),k=K("tooltip");return p(),y("div",V,[f.value?E("",!0):W((p(),y("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=I=>{b(_)(),f.value=!0})},e[1]||(e[1]=[q("div",{class:"i-la-microphone"},null,-1)]))),[[k,"Enable audio input"]]),(p(),R(T,{onUpdate:L,key:b(z)},{default:s(()=>[n(d,{name:"buffer0",code:m.value},{default:s(()=>[n(o,{name:"u_light",value:v.value},null,8,["value"]),n(r,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),n(d,{name:"buffer1",code:m.value},{default:s(()=>[n(o,{name:"u_light",value:v.value},null,8,["value"]),n(r,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),n(d,{name:"main",code:F.value},{default:s(()=>[n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}};export{Q as default};
