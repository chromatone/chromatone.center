import{an as A,r as g,c as l,ay as O,aC as j,aZ as N,a6 as c,Y as B,C as p,D as y,I as K,K as b,N as M,R,S as s,a0 as e,F as W}from"./framework.D0WAkjk4.js";import{H as q,u as E}from"./theme.CjOXjCIt.js";const P=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},I=W("div",{class:"i-la-microphone"},null,-1),U=[I],$={__name:"ChromaPaletteFeedback",setup(G){const{tuner:u,init:_}=q(),{width:x,height:C}=A(),v=g(0),f=g(!1),{midi:a}=E(),m=l(()=>P),w=l(()=>{let t=new Array(12).fill(0);for(let n in a==null?void 0:a.activeNotes){const o=(Number(n)-9)%12;t[o]+=a==null?void 0:a.activeNotes[n]}return t.map((n,o)=>{let r=Math.pow(u.aChroma[o],2),i=r>Math.pow(u.chromaAvg,2)&&!u.note.silent?r:0;return n+i})}),D=O(w,{duration:200,transition:j.easeOutExpo}),h=l(()=>{const t=Array(16).fill(0);return D.value.forEach((n,o)=>t[o]=n),t});function S(t){v.value=(Math.sin(t.iTime)+1)/2}const L=l(()=>x.value||C.value?Math.random():0),F=N(L,100),T=l(()=>`
...
`);return(t,n)=>{const o=c("gl-float"),r=c("gl-mat4"),i=c("gl-image"),d=c("gl-program"),k=c("gl-canvas"),z=B("tooltip");return p(),y("div",V,[f.value?M("",!0):K((p(),y("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:n[0]||(n[0]=H=>{b(_)(),f.value=!0})},U)),[[z,"Enable audio input"]]),(p(),R(k,{onUpdate:S,key:b(F)},{default:s(()=>[e(d,{name:"buffer0",code:m.value},{default:s(()=>[e(o,{name:"u_light",value:v.value},null,8,["value"]),e(r,{name:"u_notes",value:h.value},null,8,["value"]),e(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),e(d,{name:"buffer1",code:m.value},{default:s(()=>[e(o,{name:"u_light",value:v.value},null,8,["value"]),e(r,{name:"u_notes",value:h.value},null,8,["value"]),e(i,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),e(d,{name:"main",code:T.value},{default:s(()=>[e(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}};export{$ as default};
