import{ak as A,r as g,G as r,aJ as O,aO as j,aP as B,i as l,a0 as M,q as y,f as d,R as N,t as q,e as K,u as b,s as P,j as c,l as n}from"./framework.D01lOa8K.js";import{aP as R,N as W}from"./theme.7_GhOmt2.js";const E=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},$={__name:"ChromaPaletteFeedback",setup(G){const{tuner:s,init:_}=R(),{width:x,height:C}=A(),u=g(0),p=g(!1),{activeNotes:f}=W(),m=r(()=>E),w=r(()=>{let t=new Array(12).fill(0);for(let e in f.value){const o=(Number(e)-9)%12;t[o]+=f.value[e]}return t.map((e,o)=>{let a=Math.pow(s.aChroma[o],2),i=a>Math.pow(s.chromaAvg,2)&&!s.note.silent?a:0;return e+i})}),D=O(w,{duration:200,transition:j.easeOutExpo}),h=r(()=>{const t=Array(16).fill(0);return D.value.forEach((e,o)=>t[o]=e),t});function S(t){u.value=(Math.sin(t.iTime)+1)/2}const L=r(()=>x.value||C.value?Math.random():0),k=B(L,100),F=r(()=>`
...
`);return(t,e)=>{const o=l("gl-float"),a=l("gl-mat4"),i=l("gl-image"),v=l("gl-program"),T=l("gl-canvas"),z=M("tooltip");return d(),y("div",V,[p.value?q("",!0):N((d(),y("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=U=>{b(_)(),p.value=!0})},e[1]||(e[1]=[P("div",{class:"i-la-microphone"},null,-1)]))),[[z,"Enable audio input"]]),(d(),K(T,{onUpdate:S,key:b(k)},{default:c(()=>[n(v,{name:"buffer0",code:m.value},{default:c(()=>[n(o,{name:"u_light",value:u.value},null,8,["value"]),n(a,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),n(v,{name:"buffer1",code:m.value},{default:c(()=>[n(o,{name:"u_light",value:u.value},null,8,["value"]),n(a,{name:"u_notes",value:h.value},null,8,["value"]),n(i,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),n(v,{name:"main",code:F.value},{default:c(()=>[n(i,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}};export{$ as default};
