import{B as F,n as O,T as j,D as B}from"./index.abf15ce3.js";import{u as N}from"./midi.546d3551.js";import{u as E}from"./tuner.d38ecc13.js";import"./audio.85cd45c5.js";import"./colors.027ae8bf.js";import"./loop.ec0ace32.js";import"./mic.dd98a9ae.js";import"./Midi.1f918097.js";import"./tempo.979347f7.js";import"./noise.fb160676.js";import"./index.83aed4fc.js";import"./sequence.3628490b.js";import"./synth.c8d61a9f.js";import"./theory.61e5aadb.js";import{k as f,i as r,B as a,l as K,o as s,c as h,w as W,u as g,g as q,f as M,x as p,e as i,a as P}from"./framework.11beae03.js";import"./index.e5c73bca.js";import"./commonjsHelpers.de833af9.js";import"./index.b30cd6d2.js";import"./calculations.65ee336d.js";import"./index.654bd828.js";import"./index.6b4e0cd9.js";import"./midiRender.cde9826c.js";import"./Sequence.a9c1c185.js";import"./Loop.b192c9c2.js";import"./UserMedia.4741de0f.js";import"./Subtract.f0fef764.js";import"./OnePoleFilter.2d0525f8.js";import"./FFT.316b1980.js";import"./BitCrusher.f85da583.js";import"./Filter.2b531c53.js";import"./AutoPanner.e7ac4fed.js";import"./Scale.7b617051.js";import"./PingPongDelay.b93d6a29.js";import"./MonoSynth.4cac63d2.js";import"./index.86652af6.js";const R=`// precision highp float;
...
}`,V={class:"relative min-h-70svh h-80svh rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},U=P("div",{class:"i-la-microphone"},null,-1),I=[U],ke={__name:"ExpShader",setup($){const{tuner:l,init:y}=E(),{width:b,height:_}=F(),v=f(0),d=f(!1),{midi:t}=N(),x=r(()=>R),C=r(()=>{let n=new Array(12).fill(0);for(let e in t==null?void 0:t.activeNotes){const o=(Number(e)-9)%12;n[o]+=t==null?void 0:t.activeNotes[e]}return n.map((e,o)=>{let c=l.aChroma[o]>l.chromaAvg&&!l.note.silent?l.aChroma[o]:0;return e+c})}),w=O(C,{duration:200,transition:j.easeOutExpo}),D=r(()=>{const n=Array(16).fill(0);return w.value.forEach((e,o)=>n[o]=e),n});function S(n){v.value=(Math.sin(n.iTime)+1)/2}const L=r(()=>b.value||_.value?Math.random():0),T=B(L,100),z=r(()=>`
...
`);return(n,e)=>{const o=a("gl-float"),c=a("gl-mat4"),m=a("gl-image"),u=a("gl-program"),k=a("gl-canvas"),A=K("tooltip");return s(),h("div",V,[d.value?q("",!0):W((s(),h("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=G=>{g(y)(),d.value=!0})},I)),[[A,"Enable audio input"]]),(s(),M(k,{onUpdate:S,key:g(T)},{default:p(()=>[i(u,{name:"buffer0",code:x.value},{default:p(()=>[i(o,{name:"u_light",value:v.value},null,8,["value"]),i(c,{name:"u_notes",value:D.value},null,8,["value"]),i(m,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),i(u,{name:"main",code:z.value},{default:p(()=>[i(m,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{ke as default};
