import{P as f,r,M as a,j as O,v as s,b as h,Z as j,N as g,B as k,C as M,O as p,T as i,F as K}from"./framework.7e747cd7.js";import{B as N,m as P,T as W,D as q}from"./index.c0ca431c.js";import{u as B}from"./midi.290fabf9.js";import{u as E}from"./tuner.f1245b29.js";import"./audio.170dbcbf.js";import"./colors.abbc28c6.js";import"./loop.dc25aa47.js";import"./mic.967a994c.js";import"./Midi.1f918097.js";import"./tempo.fceb0f15.js";import"./noise.0a2eacbf.js";import"./index.83aed4fc.js";import"./sequence.5b4cde29.js";import"./synth.220fb0dd.js";import"./theory.61e5aadb.js";import"./index.0b97d2b2.js";import"./commonjsHelpers.de833af9.js";import"./index.b30cd6d2.js";import"./calculations.3384a913.js";import"./index.654bd828.js";import"./index.b77db23e.js";import"./midiRender.6c0c3f09.js";import"./Sequence.a9c1c185.js";import"./Loop.b192c9c2.js";import"./UserMedia.4741de0f.js";import"./Subtract.f0fef764.js";import"./OnePoleFilter.2d0525f8.js";import"./FFT.4a41ae6b.js";import"./BitCrusher.884c5bbc.js";import"./Filter.2b531c53.js";import"./AutoPanner.94a306f8.js";import"./Scale.7b617051.js";import"./PingPongDelay.38a34857.js";import"./MonoSynth.4cac63d2.js";import"./index.86652af6.js";const R=`// precision highp float;
...
}`,U={class:"relative min-h-70svh h-80svh rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},Z=K("div",{class:"i-la-microphone"},null,-1),I=[Z],Ae={__name:"ExpShader",setup($){const{tuner:l,init:y}=E(),{width:b,height:_}=N(),v=f(0),d=f(!1),{midi:t}=B(),x=r(()=>R),C=r(()=>{let n=new Array(12).fill(0);for(let e in t==null?void 0:t.activeNotes){const o=(Number(e)-9)%12;n[o]+=t==null?void 0:t.activeNotes[e]}return n.map((e,o)=>{let c=l.aChroma[o]>l.chromaAvg&&!l.note.silent?l.aChroma[o]:0;return e+c})}),w=P(C,{duration:200,transition:W.easeOutExpo}),S=r(()=>{const n=Array(16).fill(0);return w.value.forEach((e,o)=>n[o]=e),n});function D(n){v.value=(Math.sin(n.iTime)+1)/2}const L=r(()=>b.value||_.value?Math.random():0),T=q(L,100),z=r(()=>`
...
`);return(n,e)=>{const o=a("gl-float"),c=a("gl-mat4"),m=a("gl-image"),u=a("gl-program"),A=a("gl-canvas"),F=O("tooltip");return s(),h("div",U,[d.value?k("",!0):j((s(),h("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=G=>{g(y)(),d.value=!0})},I)),[[F,"Enable audio input"]]),(s(),M(A,{onUpdate:D,key:g(T)},{default:p(()=>[i(u,{name:"buffer0",code:x.value},{default:p(()=>[i(o,{name:"u_light",value:v.value},null,8,["value"]),i(c,{name:"u_notes",value:S.value},null,8,["value"]),i(m,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),i(u,{name:"main",code:z.value},{default:p(()=>[i(m,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{Ae as default};
