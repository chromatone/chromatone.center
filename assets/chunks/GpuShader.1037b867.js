import{d as F,e as O,T as j,r as N}from"./index.70261d75.js";import{u as q}from"./midi.b5556f9f.js";import{u as B}from"./tuner.5a4b9afc.js";import"./audio.e7507cf6.js";import"./colors.71e97f2b.js";import"./loop.88bd9d68.js";import"./mic.dc5fa472.js";import"./midiRender.1914f0ed.js";import"./Midi.1f918097.js";import"./tempo.84043c62.js";import"./noise.4e878d58.js";import"./index.e98b5e67.js";import"./sequence.8d866e24.js";import"./synth.9919606b.js";import"./theory.f78bd4d6.js";import{i as f,j as i,m as r,q as K,o as p,c as g,s as M,g as h,b as W,e as E,n as v,f as a,a as P}from"./framework.88db3c26.js";const R=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},U=P("div",{class:"i-la-microphone"},null,-1),G=[U],pe={__name:"GpuShader",setup(I){const{tuner:s,init:y}=B(),{width:b,height:_}=F(),d=f(0),u=f(!1),{midi:t}=q(),x=i(()=>R),C=i(()=>{let n=new Array(12).fill(0);for(let e in t==null?void 0:t.activeNotes){const o=(Number(e)-9)%12;n[o]+=t==null?void 0:t.activeNotes[e]}return n.map((e,o)=>{let l=Math.pow(s.aChroma[o],2),c=l>s.chromaAvg&&!s.note.silent?l:0;return e+c})}),w=O(C,{duration:200,transition:j.easeOutExpo}),D=i(()=>{const n=Array(16).fill(0);return w.value.forEach((e,o)=>n[o]=e),n});function S(n){d.value=(Math.sin(n.iTime)+1)/2}const L=i(()=>b.value||_.value?Math.random():0),T=N(L,100),z=i(()=>`
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),m=r("gl-program"),k=r("gl-canvas"),A=K("tooltip");return p(),g("div",V,[u.value?W("",!0):M((p(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=$=>{h(y)(),u.value=!0})},G)),[[A,"Enable audio input"]]),(p(),E(k,{onUpdate:S,key:h(T)},{default:v(()=>[a(m,{name:"buffer0",code:x.value},{default:v(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(m,{name:"main",code:z.value},{default:v(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{pe as _};
