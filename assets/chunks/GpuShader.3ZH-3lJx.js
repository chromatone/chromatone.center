import{am as F,r as m,c as i,aw as O,ax as j,ay as B,a5 as r,Y as N,e as v,f as g,j as K,k as h,p as M,A as W,B as p,a0 as a,g as q}from"./framework.De1wmbud.js";import{H as E,u as P}from"./theme.DaHGH2Mp.js";const R=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},U=q("div",{class:"i-la-microphone"},null,-1),G=[U],J={__name:"GpuShader",setup(H){const{tuner:s,init:y}=E(),{width:b,height:_}=F(),d=m(0),u=m(!1),{midi:t}=P(),x=i(()=>R),w=i(()=>{let n=new Array(12).fill(0);for(let e in t==null?void 0:t.activeNotes){const o=(Number(e)-9)%12;n[o]+=t==null?void 0:t.activeNotes[e]}return n.map((e,o)=>{let l=Math.pow(s.aChroma[o],2),c=l>s.chromaAvg&&!s.note.silent?l:0;return e+c})}),C=O(w,{duration:200,transition:j.easeOutExpo}),D=i(()=>{const n=Array(16).fill(0);return C.value.forEach((e,o)=>n[o]=e),n});function S(n){d.value=(Math.sin(n.iTime)+1)/2}const L=i(()=>b.value||_.value?Math.random():0),T=B(L,100),z=i(()=>`
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),f=r("gl-program"),k=r("gl-canvas"),A=N("tooltip");return v(),g("div",V,[u.value?M("",!0):K((v(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=I=>{h(y)(),u.value=!0})},G)),[[A,"Enable audio input"]]),(v(),W(k,{onUpdate:S,key:h(T)},{default:p(()=>[a(f,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(f,{name:"main",code:z.value},{default:p(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{J as _};
