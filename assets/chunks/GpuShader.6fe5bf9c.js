import{d as F,e as O,T as j,r as N}from"./index.8dc0b613.js";import{u as q}from"./midi.36560961.js";import{u as B}from"./tuner.f3d8e340.js";import"./audio.aba48680.js";import"./colors.a5d5ae39.js";import"./loop.5f39f706.js";import"./mic.a8597eff.js";import"./midiRender.affeda4e.js";import"./Midi.1f918097.js";import"./tempo.4e2f4c38.js";import"./noise.50c0df1a.js";import"./index.e98b5e67.js";import"./sequence.23b98f68.js";import"./synth.8a2ee66e.js";import"./theory.61e5aadb.js";import{i as f,j as i,m as r,q as K,o as s,c as g,s as W,g as h,b as E,e as M,n as p,f as a,a as P}from"./framework.f277db28.js";const R=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},U=P("div",{class:"i-la-microphone"},null,-1),G=[U],pe={__name:"GpuShader",setup(I){const{tuner:l,init:y}=B(),{width:b,height:_}=F(),v=f(0),d=f(!1),{midi:t}=q(),x=i(()=>R),C=i(()=>{let n=new Array(12).fill(0);for(let e in t==null?void 0:t.activeNotes){const o=(Number(e)-9)%12;n[o]+=t==null?void 0:t.activeNotes[e]}return n.map((e,o)=>{let c=l.aChroma[o]>l.chromaAvg&&!l.note.silent?l.aChroma[o]:0;return e+c})}),w=O(C,{duration:200,transition:j.easeOutExpo}),D=i(()=>{const n=Array(16).fill(0);return w.value.forEach((e,o)=>n[o]=e),n});function S(n){v.value=(Math.sin(n.iTime)+1)/2}const L=i(()=>b.value||_.value?Math.random():0),T=N(L,100),z=i(()=>`
...
`);return(n,e)=>{const o=r("gl-float"),c=r("gl-mat4"),u=r("gl-image"),m=r("gl-program"),k=r("gl-canvas"),A=K("tooltip");return s(),g("div",V,[d.value?E("",!0):W((s(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=$=>{h(y)(),d.value=!0})},G)),[[A,"Enable audio input"]]),(s(),M(k,{onUpdate:S,key:h(T)},{default:p(()=>[a(m,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:v.value},null,8,["value"]),a(c,{name:"u_notes",value:D.value},null,8,["value"]),a(u,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(m,{name:"main",code:z.value},{default:p(()=>[a(u,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{pe as _};
