import{am as F,r as m,c as i,aw as O,ax as j,ay as B,a5 as r,W as M,v,x as g,B as N,D as h,H as W,L as K,M as p,X as a,z as q}from"./framework.BiLeRUvw.js";import{Q as E,u as P}from"./theme.DT5mKq_f.js";const R=`// precision highp float;
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),f=r("gl-program"),k=r("gl-canvas"),A=M("tooltip");return v(),g("div",V,[u.value?W("",!0):N((v(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=I=>{h(y)(),u.value=!0})},G)),[[A,"Enable audio input"]]),(v(),K(k,{onUpdate:L,key:h(z)},{default:p(()=>[a(f,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(f,{name:"main",code:T.value},{default:p(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{$ as _};
