import{am as F,r as m,c as i,at as O,au as j,av as N,a4 as r,M,E as v,F as g,N as B,C as h,T as E,a2 as K,X as p,O as a,G as W}from"./framework.BtWLkna7.js";import{J as q,u as P}from"./theme.DSIy9F6p.js";const R=`// precision highp float;
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),f=r("gl-program"),k=r("gl-canvas"),A=M("tooltip");return v(),g("div",V,[u.value?E("",!0):B((v(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=J=>{h(y)(),u.value=!0})},U)),[[A,"Enable audio input"]]),(v(),K(k,{onUpdate:S,key:h(T)},{default:p(()=>[a(f,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(f,{name:"main",code:z.value},{default:p(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{H as _};
