import{am as O,r as m,c as i,aw as F,ax as j,ay as B,a4 as r,V as M,v,x as g,B as N,D as h,H as W,L as K,M as p,W as a,z as q}from"./framework.C7hFoqOj.js";import{O as E,u as V}from"./theme.BwFCI582.js";const P=`// precision highp float;
...
}`,R={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},U=q("div",{class:"i-la-microphone"},null,-1),G=[U],Q={__name:"GpuShader",setup(H){const{tuner:s,init:y}=E(),{width:b,height:_}=O(),d=m(0),u=m(!1),{midi:t}=V(),x=i(()=>P),w=i(()=>{let n=new Array(12).fill(0);for(let e in t==null?void 0:t.activeNotes){const o=(Number(e)-9)%12;n[o]+=t==null?void 0:t.activeNotes[e]}return n.map((e,o)=>{let l=Math.pow(s.aChroma[o],2),c=l>s.chromaAvg&&!s.note.silent?l:0;return e+c})}),C=F(w,{duration:200,transition:j.easeOutExpo}),D=i(()=>{const n=Array(16).fill(0);return C.value.forEach((e,o)=>n[o]=e),n});function L(n){d.value=(Math.sin(n.iTime)+1)/2}const S=i(()=>b.value||_.value?Math.random():0),z=B(S,100),T=i(()=>`
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),f=r("gl-program"),k=r("gl-canvas"),A=M("tooltip");return v(),g("div",R,[u.value?W("",!0):N((v(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=I=>{h(y)(),u.value=!0})},G)),[[A,"Enable audio input"]]),(v(),K(k,{onUpdate:L,key:h(z)},{default:p(()=>[a(f,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(f,{name:"main",code:T.value},{default:p(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{Q as _};
