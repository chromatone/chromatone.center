import{W as F,i as f,j as i,X as O,Y as j,Z as N,m as r,x as W,o as s,c as g,y as B,h,d as K,f as q,n as p,g as a,a as E}from"./framework.2f46aeb8.js";import{u as M}from"./midi.0fea24b9.js";import{u as P}from"./tuner.c11a4e88.js";import"./audio.e0c178f7.js";import"./colors.93330ee5.js";import"./loop.95aab527.js";import"./mic.47236f68.js";import"./midiRender.ed5d5da0.js";import"./Midi.1f918097.js";import"./tempo.a46486f1.js";import"./noise.9842c7ac.js";import"./index.3012fc8f.js";import"./sequence.cfe1e93c.js";import"./synth.05e847c0.js";import"./theory.61e5aadb.js";const R=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},U=E("div",{class:"i-la-microphone"},null,-1),G=[U],se={__name:"GpuShader",setup(I){const{tuner:l,init:y}=P(),{width:b,height:_}=F(),v=f(0),d=f(!1),{midi:t}=M(),x=i(()=>R),C=i(()=>{let n=new Array(12).fill(0);for(let e in t==null?void 0:t.activeNotes){const o=(Number(e)-9)%12;n[o]+=t==null?void 0:t.activeNotes[e]}return n.map((e,o)=>{let c=l.aChroma[o]>l.chromaAvg&&!l.note.silent?l.aChroma[o]:0;return e+c})}),w=O(C,{duration:200,transition:j.easeOutExpo}),D=i(()=>{const n=Array(16).fill(0);return w.value.forEach((e,o)=>n[o]=e),n});function S(n){v.value=(Math.sin(n.iTime)+1)/2}const L=i(()=>b.value||_.value?Math.random():0),T=N(L,100),z=i(()=>`
...
`);return(n,e)=>{const o=r("gl-float"),c=r("gl-mat4"),u=r("gl-image"),m=r("gl-program"),k=r("gl-canvas"),A=W("tooltip");return s(),g("div",V,[d.value?K("",!0):B((s(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=X=>{h(y)(),d.value=!0})},G)),[[A,"Enable audio input"]]),(s(),q(k,{onUpdate:S,key:h(T)},{default:p(()=>[a(m,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:v.value},null,8,["value"]),a(c,{name:"u_notes",value:D.value},null,8,["value"]),a(u,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(m,{name:"main",code:z.value},{default:p(()=>[a(u,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{se as _};
