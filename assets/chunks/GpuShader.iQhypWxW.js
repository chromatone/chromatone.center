import{O,i as f,j as i,P as F,Q as j,R as N,m as r,x as B,o as p,c as g,y as K,g as h,b as M,e as W,n as v,f as a,a as q}from"./framework.1uYGFCry.js";import{u as E}from"./midi.JUoUGMo3.js";import{u as P}from"./tuner.Ezt5vaUc.js";import"./audio.MFPk3EpQ.js";import"./colors.DQ3Nq55L.js";import"./loop.D0hV7T70.js";import"./mic.qHB2ZCa_.js";import"./midiRender.uVc9GHxZ.js";import"./Midi.6fTTQsck.js";import"./tempo.tDAToNwG.js";import"./noise.eEwbfwiD.js";import"./index.RYxauP_R.js";import"./sequence.FcV5CLma.js";import"./synth.CftW3DNb.js";import"./theory.dOWEiwk1.js";const R=`// precision highp float;
...
}`,V={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},U=q("div",{class:"i-la-microphone"},null,-1),G=[U],se={__name:"GpuShader",setup(I){const{tuner:s,init:y}=P(),{width:b,height:_}=O(),d=f(0),u=f(!1),{midi:t}=E(),x=i(()=>R),C=i(()=>{let n=new Array(12).fill(0);for(let e in t==null?void 0:t.activeNotes){const o=(Number(e)-9)%12;n[o]+=t==null?void 0:t.activeNotes[e]}return n.map((e,o)=>{let l=Math.pow(s.aChroma[o],2),c=l>s.chromaAvg&&!s.note.silent?l:0;return e+c})}),w=F(C,{duration:200,transition:j.easeOutExpo}),D=i(()=>{const n=Array(16).fill(0);return w.value.forEach((e,o)=>n[o]=e),n});function S(n){d.value=(Math.sin(n.iTime)+1)/2}const L=i(()=>b.value||_.value?Math.random():0),T=N(L,100),z=i(()=>`
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),m=r("gl-program"),k=r("gl-canvas"),A=B("tooltip");return p(),g("div",V,[u.value?M("",!0):K((p(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=Q=>{h(y)(),u.value=!0})},G)),[[A,"Enable audio input"]]),(p(),W(k,{onUpdate:S,key:h(T)},{default:v(()=>[a(m,{name:"buffer0",code:x.value},{default:v(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(m,{name:"main",code:z.value},{default:v(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{se as _};
