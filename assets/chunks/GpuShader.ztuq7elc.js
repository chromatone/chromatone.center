import{am as F,r as m,c as i,as as O,at as j,au as N,a4 as r,M as K,E as v,F as g,N as M,C as h,T as B,a2 as E,X as p,O as a,G as W}from"./framework.NDjH5Ni5.js";import{K as q,u as P}from"./theme.8Rdgh56L.js";const R=`// precision highp float;
...
`);return(n,e)=>{const o=r("gl-float"),l=r("gl-mat4"),c=r("gl-image"),f=r("gl-program"),k=r("gl-canvas"),A=K("tooltip");return v(),g("div",V,[u.value?B("",!0):M((v(),g("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=X=>{h(y)(),u.value=!0})},U)),[[A,"Enable audio input"]]),(v(),E(k,{onUpdate:S,key:h(T)},{default:p(()=>[a(f,{name:"buffer0",code:x.value},{default:p(()=>[a(o,{name:"u_light",value:d.value},null,8,["value"]),a(l,{name:"u_notes",value:D.value},null,8,["value"]),a(c,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),a(f,{name:"main",code:z.value},{default:p(()=>[a(c,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}};export{J as _};
