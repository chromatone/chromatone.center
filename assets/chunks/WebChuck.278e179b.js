import{_ as E,s as w,k as _,j as R,o as m,c as p,w as y,v as A,a as d,F as M,r as T,n as D,t as I,u as S,p as x,h as C}from"./framework.eba39b59.js";const F=`// patch
...
`,B=`// plucked string filter, different excitation
// Ge Wang (gewang@cs.princeton.edu)
...
`;class an{constructor(){this.resolve=void 0,this.reject=void 0,this.promise=new Promise((n,e)=>{this.resolve=n,this.reject=e})}async value(){return await this.promise}}function on(a,n,e){const t=new XMLHttpRequest;t.open("GET",a,!0),t.responseType="arraybuffer",t.onload=()=>{t.status==200||t.status==0&&t.response?n(t.response):e()},t.onerror=e,t.send(null)}function g(a,n,e){on(a,t=>{n(new Uint8Array(t))},()=>{if(e)e();else throw new Error(`Loading data file ${a} failed.`)})}async function rn(a){const n=a.map(e=>new Promise((t,r)=>{g(e.serverFilename,s=>{t({filename:e.virtualFilename,data:s})},()=>{console.error(`Error fetching file: ${e.serverFilename}`)})}));return await Promise.all(n)}async function sn(){return await new Promise((a,n)=>{g("https://chuck.stanford.edu/webchuck/src/webchuck.wasm",a,n)})}const b=()=>new an;var o;(function(a){a.LOAD_FILE="loadFile",a.RUN_CODE="runChuckCode",a.RUN_CODE_WITH_REPLACEMENT_DAC="runChuckCodeWithReplacementDac",a.REPLACE_CODE="replaceChuckCode",a.REPLACE_CODE_WITH_REPLACEMENT_DAC="replaceChuckCodeWithReplacementDac",a.REMOVE_LAST_CODE="removeLastCode",a.RUN_FILE="runChuckFile",a.RUN_FILE_WITH_REPLACEMENT_DAC="runChuckFileWithReplacementDac",a.RUN_FILE_WITH_ARGS="runChuckFileWithArgs",a.REPLACE_FILE="replaceChuckFile",a.REPLACE_FILE_WITH_REPLACEMENT_DAC="replaceChuckFileWithReplacementDac",a.REPLACE_FILE_WITH_ARGS="replaceChuckFileWithArgs",a.REMOVE_SHRED="removeShred",a.IS_SHRED_ACTIVE="isShredActive",a.SIGNAL_EVENT="signalChuckEvent",a.BROADCAST_EVENT="broadcastChuckEvent",a.LISTEN_FOR_EVENT_ONCE="listenForEventOnce",a.START_LISTENING_FOR_EVENT="startListeningForChuckEvent",a.STOP_LISTENING_FOR_EVENT="stopListeningForChuckEvent",a.SET_INT="setChuckInt",a.GET_INT="getChuckInt",a.SET_FLOAT="setChuckFloat",a.GET_FLOAT="getChuckFloat",a.SET_STRING="setChuckString",a.GET_STRING="getChuckString",a.SET_INT_ARRAY="setGlobalIntArray",a.GET_INT_ARRAY="getGlobalIntArray",a.SET_INT_ARRAY_VALUE="setGlobalIntArrayValue",a.GET_INT_ARRAY_VALUE="getGlobalIntArrayValue",a.SET_ASSOCIATIVE_INT_ARRAY_VALUE="setGlobalAssociativeIntArrayValue",a.GET_ASSOCIATIVE_INT_ARRAY_VALUE="getGlobalAssociativeIntArrayValue",a.SET_FLOAT_ARRAY="setGlobalFloatArray",a.GET_FLOAT_ARRAY="getGlobalFloatArray",a.SET_FLOAT_ARRAY_VALUE="setGlobalFloatArrayValue",a.GET_FLOAT_ARRAY_VALUE="getGlobalFloatArrayValue",a.SET_ASSOCIATIVE_FLOAT_ARRAY_VALUE="setGlobalAssociativeFloatArrayValue",a.GET_ASSOCIATIVE_FLOAT_ARRAY_VALUE="getGlobalAssociativeFloatArrayValue",a.CLEAR_INSTANCE="clearChuckInstance",a.CLEAR_GLOBALS="clearGlobals"})(o||(o={}));var i;(function(a){a.INIT_DONE="initCallback",a.PRINT="console print",a.EVENT="eventCallback",a.INT="intCallback",a.FLOAT="floatCallback",a.STRING="stringCallback",a.INT_ARRAY="intArrayCallback",a.FLOAT_ARRAY="floatArrayCallback",a.NEW_SHRED="newShredCallback",a.REPLACED_SHRED="replacedShredCallback",a.REMOVED_SHRED="removedShredCallback"})(i||(i={}));class f extends window.AudioWorkletNode{constructor(n,e,t,r=2){super(e,"chuck-node",{numberOfInputs:1,numberOfOutputs:1,outputChannelCount:[r],processorOptions:{chuckID:f.chuckID,srate:e.sampleRate,preloadedFiles:n,wasm:t}}),this.deferredPromises={},this.deferredPromiseCounter=0,this.eventCallbacks={},this.eventCallbackCounter=0,this.isReady=b(),this.port.onmessage=this.receiveMessage.bind(this),this.onprocessorerror=s=>console.error(s),f.chuckID++}static async init(n,e,t=2){const r=await sn();typeof e>"u"&&(e=new AudioContext),e.state==="suspended"&&await e.resume(),await e.audioWorklet.addModule("https://chuck.stanford.edu/webchuck/src/webchuck.js");const s=await rn(n),h=new f(s,e,r,t);return h.connect(e.destination),await h.isReady.promise,h}nextDeferID(){const n=this.deferredPromiseCounter++;return this.deferredPromises[n]=b(),n}createFile(n,e,t){this.sendMessage(o.LOAD_FILE,{directory:n,filename:e,data:t})}async loadFile(n){return n.endsWith(".ck")?fetch(n).then(e=>e.text()).then(e=>{this.createFile("",n,e)}):fetch(n).then(e=>e.arrayBuffer()).then(e=>{this.createFile("",n,new Uint8Array(e))})}runCode(n){const e=this.nextDeferID();return this.sendMessage(o.RUN_CODE,{callback:e,code:n}),this.deferredPromises[e]}runCodeWithReplacementDac(n,e){const t=this.nextDeferID();return this.sendMessage(o.RUN_CODE_WITH_REPLACEMENT_DAC,{callback:t,code:n,dac_name:e}),this.deferredPromises[t]}replaceCode(n){const e=this.nextDeferID();return this.sendMessage(o.REPLACE_CODE,{callback:e,code:n}),this.deferredPromises[e]}replaceCodeWithReplacementDac(n,e){const t=this.nextDeferID();return this.sendMessage(o.REPLACE_CODE_WITH_REPLACEMENT_DAC,{callback:t,code:n,dac_name:e}),this.deferredPromises[t]}removeLastCode(){const n=this.nextDeferID();return this.sendMessage(o.REMOVE_LAST_CODE,{callback:n}),this.deferredPromises[n]}runFile(n){const e=this.nextDeferID();return this.sendMessage(o.RUN_FILE,{callback:e,filename:n}),this.deferredPromises[e]}runFileWithReplacementDac(n,e){const t=this.nextDeferID();return this.sendMessage(o.RUN_FILE_WITH_REPLACEMENT_DAC,{callback:t,dac_name:e,filename:n}),this.deferredPromises[t]}runFileWithArgs(n,e){const t=this.nextDeferID();return this.sendMessage(o.RUN_FILE_WITH_ARGS,{callback:t,colon_separated_args:e,filename:n}),this.deferredPromises[t]}runFileWithArgsWithReplacementDac(n,e,t){const r=this.nextDeferID();return this.sendMessage(o.RUN_FILE_WITH_ARGS,{callback:r,colon_separated_args:e,dac_name:t,filename:n}),this.deferredPromises[r]}replaceFile(n){const e=this.nextDeferID();return this.sendMessage(o.REPLACE_FILE,{callback:e,filename:n}),this.deferredPromises[e]}replaceFileWithReplacementDac(n,e){const t=this.nextDeferID();return this.sendMessage(o.REPLACE_FILE_WITH_REPLACEMENT_DAC,{callback:t,dac_name:e,filename:n}),this.deferredPromises[t]}replaceFileWithArgs(n,e){const t=this.nextDeferID();return this.sendMessage(o.REPLACE_FILE_WITH_ARGS,{callback:t,colon_separated_args:e,filename:n}),this.deferredPromises[t]}replaceFileWithArgsWithReplacementDac(n,e,t){const r=this.nextDeferID();return this.sendMessage(o.REPLACE_FILE_WITH_ARGS,{callback:r,colon_separated_args:e,dac_name:t,filename:n}),this.deferredPromises[r]}removeShred(n){const e=this.nextDeferID();return this.sendMessage(o.REMOVE_SHRED,{shred:n,callback:e}),this.deferredPromises[e]}isShredActive(n){const e=this.nextDeferID();return this.sendMessage(o.IS_SHRED_ACTIVE,{shred:n,callback:e}),this.deferredPromises[e]}signalEvent(n){this.sendMessage(o.SIGNAL_EVENT,{variable:n})}broadcastEvent(n){this.sendMessage(o.BROADCAST_EVENT,{variable:n})}listenForEventOnce(n,e){const t=this.eventCallbackCounter++;this.eventCallbacks[t]=e,this.sendMessage(o.LISTEN_FOR_EVENT_ONCE,{variable:n,callback:t})}startListeningForEvent(n,e){const t=this.eventCallbackCounter++;return this.eventCallbacks[t]=e,this.sendMessage(o.START_LISTENING_FOR_EVENT,{variable:n,callback:t}),t}stopListeningForEvent(n,e){this.sendMessage(o.STOP_LISTENING_FOR_EVENT,{variable:n,callback:e})}setInt(n,e){this.sendMessage(o.SET_INT,{variable:n,value:e})}getInt(n){const e=this.nextDeferID();return this.sendMessage(o.GET_INT,{variable:n,callback:e}),this.deferredPromises[e]}setFloat(n,e){this.sendMessage(o.SET_FLOAT,{variable:n,value:e})}getFloat(n){const e=this.nextDeferID();return this.sendMessage(o.GET_FLOAT,{variable:n,callback:e}),this.deferredPromises[e]}setString(n,e){this.sendMessage(o.SET_STRING,{variable:n,value:e})}getString(n){const e=this.nextDeferID();return this.sendMessage(o.GET_STRING,{variable:n,callback:e}),this.deferredPromises[e]}setIntArray(n,e){this.sendMessage(o.SET_INT_ARRAY,{variable:n,values:e})}getIntArray(n){const e=this.nextDeferID();return this.sendMessage(o.GET_INT_ARRAY,{variable:n,callback:e}),this.deferredPromises[e]}setIntArrayValue(n,e,t){this.sendMessage(o.SET_INT_ARRAY_VALUE,{variable:n,index:e,value:t})}getIntArrayValue(n,e){const t=this.nextDeferID();return this.sendMessage(o.GET_INT_ARRAY_VALUE,{variable:n,index:e,callback:t}),this.deferredPromises[t]}setAssociativeIntArrayValue(n,e,t){this.sendMessage(o.SET_ASSOCIATIVE_INT_ARRAY_VALUE,{variable:n,key:e,value:t})}getAssociativeIntArrayValue(n,e){const t=this.nextDeferID();return this.sendMessage(o.GET_ASSOCIATIVE_INT_ARRAY_VALUE,{variable:n,key:e,callback:t}),this.deferredPromises[t]}setFloatArray(n,e){this.sendMessage(o.SET_FLOAT_ARRAY,{variable:n,values:e})}getFloatArray(n){const e=this.nextDeferID();return this.sendMessage(o.GET_FLOAT_ARRAY,{variable:n,callback:e}),this.deferredPromises[e]}setFloatArrayValue(n,e,t){this.sendMessage(o.SET_FLOAT_ARRAY_VALUE,{variable:n,index:e,value:t})}getFloatArrayValue(n,e){const t=this.nextDeferID();return this.sendMessage(o.GET_FLOAT_ARRAY_VALUE,{variable:n,index:e,callback:t}),this.deferredPromises[t]}setAssociativeFloatArrayValue(n,e,t){this.sendMessage(o.SET_ASSOCIATIVE_FLOAT_ARRAY_VALUE,{variable:n,key:e,value:t})}getAssociativeFloatArrayValue(n,e){const t=this.nextDeferID();return this.sendMessage(o.GET_ASSOCIATIVE_FLOAT_ARRAY_VALUE,{variable:n,key:e,callback:t}),this.deferredPromises[t]}clearChuckInstance(){this.sendMessage(o.CLEAR_INSTANCE)}clearGlobals(){this.sendMessage(o.CLEAR_GLOBALS)}chuckPrint(n){console.log(n)}sendMessage(n,e){const t=e?{type:n,...e}:{type:n};this.port.postMessage(t)}receiveMessage(n){switch(n.data.type){case i.INIT_DONE:this.isReady&&this.isReady.resolve&&this.isReady.resolve();break;case i.PRINT:this.chuckPrint(n.data.message);break;case i.EVENT:if(n.data.callback in this.eventCallbacks){const t=this.eventCallbacks[n.data.callback];t()}break;case i.INT:case i.FLOAT:case i.STRING:case i.INT_ARRAY:case i.FLOAT_ARRAY:if(n.data.callback in this.deferredPromises){const t=this.deferredPromises[n.data.callback];t.resolve&&t.resolve(n.data.result),delete this.deferredPromises[n.data.callback]}break;case i.NEW_SHRED:if(n.data.callback in this.deferredPromises){const t=this.deferredPromises[n.data.callback];n.data.shred>0?t.resolve&&t.resolve(n.data.shred):t.reject&&t.reject("Running code failed")}break;case i.REPLACED_SHRED:if(n.data.callback in this.deferredPromises){const t=this.deferredPromises[n.data.callback];n.data.newShred>0?t.resolve&&t.resolve({newShred:n.data.newShred,oldShred:n.data.oldShred}):t.reject&&t.reject("Replacing code failed")}break;case i.REMOVED_SHRED:if(n.data.callback in this.deferredPromises){const t=this.deferredPromises[n.data.callback];n.data.shred>0?t.resolve&&t.resolve(n.data.shred):t.reject&&t.reject("Removing code failed")}break}}}f.chuckID=1;const k=a=>(x("data-v-e6cc343a"),a=a(),C(),a),ln={class:"flex flex-col gap-2"},cn=k(()=>d("div",{class:"text-3xl"},"CHUCK ",-1)),dn=k(()=>d("div",{class:"text-sm"},"Paste any ChucK code and press Run to hear generated sound. ",-1)),fn={class:"flex flex-wrap gap-2"},hn={key:0,class:"p-2 text-green-600 dark-text-green-300"},mn={class:"flex flex-wrap gap-2"},pn=["onClick"],un={__name:"WebChuck",setup(a){const n=Object.assign({"./examples/blowhole.ck":F,"./examples/bowed.ck":L,"./examples/brass.ck":q,"./examples/chant.ck":N,"./examples/clarinet.ck":P,"./examples/flute.ck":G,"./examples/hevymetl-dance-now.ck":O,"./examples/hevymetl-trumpet-algo3.ck":V,"./examples/imp.ck":W,"./examples/lfo.ck":U,"./examples/mandolin.ck":H,"./examples/modalbar.ck":Y,"./examples/moog.ck":z,"./examples/plu.ck":j,"./examples/plu2.ck":B,"./examples/plu3.ck":J,"./examples/rhodey.ck":K,"./examples/shake-o-matic.ck":Z,"./examples/sitar.ck":$,"./examples/stif-o-karp.ck":Q,"./examples/stifkarp.ck":X,"./examples/unclap.ck":nn,"./examples/voic-o-form.ck":en,"./examples/wurley.ck":tn});function e(u){return u.match(/([^./]+)(?=\.[^.]*$|$)/)[1]}const t=w(),r=_(!1),s=_(n["./examples/brass.ck"]);R(async()=>{t.value=await f.init([]),t.value.onprocessorerror=u=>{console.warn(u)},r.value=!0});async function h(){t.value=await f.init([])}return(u,l)=>(m(),p("div",ln,[cn,dn,y(d("textarea",{class:"font-mono text-sm p-2 w-full dark-bg-dark-200 rounded-lg","onUpdate:modelValue":l[0]||(l[0]=c=>s.value=c),cols:"55",rows:"20"},null,512),[[A,s.value]]),d("div",fn,[r.value?(m(),p("div",hn,"READY")):(m(),p("div",{key:1,class:"p-2 text-orange-600 dark-text-orange-300",onClick:l[1]||(l[1]=c=>h())},"INIT")),d("button",{class:"text-button flex-1",onClick:l[2]||(l[2]=c=>t.value.runCode(s.value))},"RUN"),d("button",{class:"text-button flex-1",onClick:l[3]||(l[3]=c=>t.value.replaceCode(s.value))},"RERUN "),d("button",{class:"text-button flex-1",onClick:l[4]||(l[4]=c=>t.value.removeLastCode())},"STOP")]),d("div",mn,[(m(!0),p(M,null,T(S(n),(c,v)=>(m(),p("div",{class:D(["p-2 border-1 rounded-lg border-dark-200 cursor-pointer",{active:c==s.value}]),key:c,onClick:_n=>s.value=c},I(e(v)),11,pn))),128))])]))}},gn=E(un,[["__scopeId","data-v-e6cc343a"]]);export{gn as default};
