import{a2 as x,_ as E,o as p,c as _,I as T}from"./framework.f277db28.js";const v=`precision highp float;
precision highp int;
...
}`,R=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame,f=window.cancelAnimationFrame||window.mozCancelAnimationFrame||window.webkitCancelAnimationFrame||window.msCancelAnimationFrame,d=24*60*60;class y{constructor(t=!1){this._paused=t,this.ready=new Promise(e=>{this._readyResolve=e}),this._commonCode="",this.EXT_LOD=null,this.EXT_DERIVATIVES=null}get commonCode(){return this._commonCode}set commonCode(t){this._commonCode!==t&&(this._commonCode=t,this.programStore&&Object.keys(this.programStore).forEach(e=>{this.updateProgram(e)}))}initVertex(){this.vertexBuffer=this.gl.createBuffer(),this.gl.bindBuffer(this.gl.ARRAY_BUFFER,this.vertexBuffer),this.gl.bufferData(this.gl.ARRAY_BUFFER,new Float32Array([1,1,-1,1,1,-1,-1,-1]),this.gl.STATIC_DRAW)}get paused(){return this._paused}set paused(t){this._paused=t,f(this.timer),t||this.autoRender()}init(t,e,r){this.canvas=t,this.canvasRect=e,this.commonCode=r,this.gl=t.getContext("webgl",{alpha:!0}),this.setExtension(),this.initVertex(),this.iResolution=[this.gl.drawingBufferWidth,this.gl.drawingBufferHeight,0],this.iMouse=[0,0,0,0],this.resetTime(),this.gl.clearColor(0,0,0,0),this.gl.pixelStorei(this.gl.UNPACK_FLIP_Y_WEBGL,!0),this.gl.enable(this.gl.BLEND),this.gl.blendFunc(this.gl.SRC_ALPHA,this.gl.ONE_MINUS_SRC_ALPHA),this.initVertShader(),this.setSize(),this.event(),this.paused||this.autoRender(),this._readyResolve()}setExtension(){const t=this.gl.getExtension("OES_texture_half_float");this.EXT_FLOAT=t&&t.HALF_FLOAT_OES||this.gl.UNSIGNED_BYTE,this.gl.getExtension("OES_texture_half_float_linear"),this.EXT_DERIVATIVES=this.gl.getExtension("OES_standard_derivatives"),this.EXT_LOD=this.gl.getExtension("EXT_shader_texture_lod")}setSize(){this.gl.viewport(0,0,this.iResolution[0],this.iResolution[1])}resetTime(){this.iTime=this.iTimeDelta=this.iFrame=0;const t=new Date;this.initTime=t.getTime()/1e3,this.iDate=[t.getFullYear(),t.getMonth(),t.getDate(),this.initTime/1e3%d]}event(){const t=e=>{this.iMouse[0]=(e.pageX-this.canvasRect.left)*this.gl.drawingBufferWidth/this.canvasRect.width,this.iMouse[1]=(this.canvasRect.height-(e.pageY-this.canvasRect.top))*this.gl.drawingBufferHeight/this.canvasRect.height};this.canvas.addEventListener("touchstart",e=>{this.iMouse[2]=this.iMouse[3]=1,t(e.touches[0])},!1),this.canvas.addEventListener("mousedown",e=>{this.iMouse[2]=this.iMouse[3]=1,t(e)},!1),this.canvas.addEventListener("touchmove",e=>{e.stopPropagation(),e.preventDefault(),t(e.touches[0])},!1),this.canvas.addEventListener("mousemove",t,!1),this.canvas.addEventListener("touchend",()=>{this.iMouse[2]=this.iMouse[3]=0},!1),this.canvas.addEventListener("mouseup",()=>{this.iMouse[2]=this.iMouse[3]=0},!1)}autoRender(){const t=new Date,e=t.getTime()/1e3,r=e-this.initTime;this.iTimeDelta=r-this.iTime,this.iTime=r,this.iDate=[t.getFullYear(),t.getMonth(),t.getDate(),e%d],this.iFrame++,this.render(),this.timer=R(()=>{this.autoRender()})}render(){Object.keys(this.programStore).forEach(t=>{const e=this.programStore[t],r=e.program;if(!r)return;this.gl.bindFramebuffer(this.gl.FRAMEBUFFER,e.frameBuffer||null),t!=="main"&&([e.frameTexture,e.cacheTexture]=[e.cacheTexture,e.frameTexture],this.gl.bindTexture(this.gl.TEXTURE_2D,e.frameTexture),this.gl.framebufferTexture2D(this.gl.FRAMEBUFFER,this.gl.COLOR_ATTACHMENT0,this.gl.TEXTURE_2D,e.frameTexture,0)),this.gl.useProgram(r),this.gl.bindBuffer(this.gl.ARRAY_BUFFER,this.vertexBuffer);const n=e.defaultLocation.aPosition;this.gl.vertexAttribPointer(n,2,this.gl.FLOAT,!1,0,0),this.gl.enableVertexAttribArray(n),this.gl.uniform3fv(e.defaultLocation.iResolution,this.iResolution),this.gl.uniform1f(e.defaultLocation.iTime,this.iTime),this.gl.uniform1f(e.defaultLocation.iTimeDelta,this.iTimeDelta),this.gl.uniform1i(e.defaultLocation.iFrame,this.iFrame),this.gl.uniform4fv(e.defaultLocation.iMouse,this.iMouse),this.gl.uniform4fv(e.defaultLocation.iDate,this.iDate),Object.values(e.uniform).forEach(i=>{switch(i.type){case"int":this.gl.uniform1i(i.id,i.value);break;case"float":this.gl.uniform1f(i.id,i.value);break;case"vec2":this.gl.uniform2fv(i.id,i.value);break;case"vec3":this.gl.uniform3fv(i.id,i.value);break;case"vec4":this.gl.uniform4fv(i.id,i.value);break;case"mat2":this.gl.uniformMatrix2fv(i.id,!1,i.value);break;case"mat3":this.gl.uniformMatrix3fv(i.id,!1,i.value);break;case"mat4":this.gl.uniformMatrix4fv(i.id,!1,i.value);break;case"sampler2D":{if(i.textureData){const m=i.textureData;if(this.gl.activeTexture(this.gl.TEXTURE0+m.id),this.gl.uniform1i(i.id,m.id),m.image)this.gl.bindTexture(this.gl.TEXTURE_2D,m.texture),m.image instanceof HTMLImageElement||this.gl.texImage2D(this.gl.TEXTURE_2D,0,this.gl.RGBA,this.gl.RGBA,this.gl.UNSIGNED_BYTE,m.image);else if(this.programStore[i.value]){const o=[this.gl.CLAMP_TO_EDGE,this.gl.REPEAT,this.gl.MIRRORED_REPEAT],s=this.programStore[i.value].cacheTexture;this.gl.bindTexture(this.gl.TEXTURE_2D,s),this.gl.texParameteri(this.gl.TEXTURE_2D,this.gl.TEXTURE_WRAP_S,o[m.repeatX]),this.gl.texParameteri(this.gl.TEXTURE_2D,this.gl.TEXTURE_WRAP_T,o[m.repeatY])}}break}case"samplerCube":{if(i.textureData){const m=i.textureData;if(this.gl.activeTexture(this.gl.TEXTURE0+m.id),this.gl.uniform1i(i.id,m.id),this.gl.bindTexture(this.gl.TEXTURE_CUBE_MAP,m.texture),m.imageCube){const o={front:this.gl.TEXTURE_CUBE_MAP_POSITIVE_Z,back:this.gl.TEXTURE_CUBE_MAP_NEGATIVE_Z,left:this.gl.TEXTURE_CUBE_MAP_POSITIVE_X,right:this.gl.TEXTURE_CUBE_MAP_NEGATIVE_X,top:this.gl.TEXTURE_CUBE_MAP_NEGATIVE_Y,bottom:this.gl.TEXTURE_CUBE_MAP_POSITIVE_Y};Object.keys(m.imageCube).forEach(s=>{const h=m.imageCube[s],l=o[s];h&&!(h instanceof HTMLImageElement)&&this.gl.texImage2D(l,0,this.gl.RGBA,this.gl.RGBA,this.gl.UNSIGNED_BYTE,h)})}}break}}}),this.gl.clear(this.gl.COLOR_BUFFER_BIT),this.gl.drawArrays(this.gl.TRIANGLE_STRIP,0,4)}),this.onUpdate&&this.onUpdate()}destroy(){f(this.timer),Object.values(this.programStore).forEach(e=>{this.gl.deleteProgram(e.program),this.gl.deleteShader(e.fragShader),e.fragShader=null,e.program=null}),this.programStore=null,this.gl.deleteBuffer(this.vertexBuffer),this.vertexBuffer=null,this.gl.deleteShader(this.vertShader),this.vertexBuffer=null,this.canvas.style.display="none";const t=this.gl.getExtension("WEBGL_lose_context");t&&t.loseContext()}initUniform(t,e,r,n,i,m){const o=this.programStore[t].uniform;if(o[e])throw new Error(`Multiple registration uniform: ${e}`);o[e]={id:null,type:r,value:n},r==="sampler2D"&&(o[e].textureData={id:this.programStore[t].textureLen++,texture:null,repeatX:i,repeatY:m}),r==="samplerCube"&&(o[e].textureData={id:this.programStore[t].textureLen++,texture:null,repeatX:0,repeatY:0})}initTexture(t,e,r,n,i,m,o,s){this.gl.useProgram(t),this.gl.activeTexture(this.gl.TEXTURE0+n),this.gl.bindTexture(i,e),this.gl.texImage2D(m,0,this.gl.RGBA,this.gl.RGBA,this.gl.UNSIGNED_BYTE,r);const h=r.naturalWidth||r.videoWidth||r.width,l=r.naturalHeight||r.videoHeight||r.height;!(h&h-1)&&!(l&l-1)?this.gl.generateMipmap(i):this.gl.texParameteri(i,this.gl.TEXTURE_MIN_FILTER,this.gl.LINEAR),this.gl.texParameteri(i,this.gl.TEXTURE_WRAP_S,o),this.gl.texParameteri(i,this.gl.TEXTURE_WRAP_T,s)}setUniform(t,e,r,n,i){const m=this.programStore[t];if(!m.program)return;const o=m.uniform[e];if(o.value=r,this.gl.useProgram(m.program),o.id===null&&(o.id=this.gl.getUniformLocation(m.program,e)),o.type==="sampler2D"){const s=o.textureData,h=[this.gl.CLAMP_TO_EDGE,this.gl.REPEAT,this.gl.MIRRORED_REPEAT];s.texture||(s.texture=this.gl.createTexture()),typeof o.value=="string"&&o.value.search(/\.(jpg|png)$|^data\:image/)>=0?(!s.image||(s.image.src||"").indexOf(o.value)<0)&&(s.image=new Image,s.image.crossOrigin="anonymous",s.image.onload=()=>{n!==void 0&&(s.repeatX=n),i!==void 0&&(s.repeatY=i),this.initTexture(m.program,s.texture,s.image,s.id,this.gl.TEXTURE_2D,this.gl.TEXTURE_2D,h[s.repeatX],h[s.repeatY])},s.image.src=o.value):o.value instanceof HTMLElement&&(s.image=r,n!==void 0&&(s.repeatX=n),i!==void 0&&(s.repeatY=i),this.initTexture(m.program,s.texture,s.image,s.id,this.gl.TEXTURE_2D,this.gl.TEXTURE_2D,h[s.repeatX],h[s.repeatY])),n!==void 0&&i!==void 0&&(s.repeatX!==n||s.repeatY!==i)&&(s.repeatX=n,s.repeatY=i,this.gl.texParameteri(this.gl.TEXTURE_2D,this.gl.TEXTURE_WRAP_S,h[s.repeatX]),this.gl.texParameteri(this.gl.TEXTURE_2D,this.gl.TEXTURE_WRAP_T,h[s.repeatY]))}if(o.type==="samplerCube"){const s=[this.gl.CLAMP_TO_EDGE,this.gl.REPEAT,this.gl.MIRRORED_REPEAT],h={front:this.gl.TEXTURE_CUBE_MAP_POSITIVE_Z,back:this.gl.TEXTURE_CUBE_MAP_NEGATIVE_Z,left:this.gl.TEXTURE_CUBE_MAP_POSITIVE_X,right:this.gl.TEXTURE_CUBE_MAP_NEGATIVE_X,top:this.gl.TEXTURE_CUBE_MAP_NEGATIVE_Y,bottom:this.gl.TEXTURE_CUBE_MAP_POSITIVE_Y},l=o.textureData;l.texture||(l.texture=this.gl.createTexture()),l.imageCube||(l.imageCube={front:null,back:null,left:null,right:null,top:null,bottom:null}),Object.keys(l.imageCube).forEach(u=>{if(typeof o.value[u]=="string"){const c=new Image;l.imageCube[u]=c,c.crossOrigin="anonymous",c.onload=()=>{this.initTexture(m.program,l.texture,c,l.id,this.gl.TEXTURE_CUBE_MAP,h[u],s[l.repeatX],s[l.repeatY])},c.src=o.value[u]}else{l.imageCube[u]=o.value[u];const c=l.imageCube[u];this.initTexture(m.program,l.texture,c,l.id,this.gl.TEXTURE_CUBE_MAP,h[u],s[l.repeatX],s[l.repeatY])}})}}initProgram(t,e){if(this.programStore||(this.programStore={}),this.programStore[t])throw new Error(`Multiple registration program: ${t}`);this.programStore[t]={uniform:{},defaultLocation:{iResolution:null,iTime:null,iTimeDelta:null,iFrame:null,iMouse:null,iDate:null,aPosition:null},fragShader:null,fragCode:e,program:null,textureLen:0}}initVertShader(){if(this.vertShader&&this.gl.deleteShader(this.vertShader),this.vertShader=this.gl.createShader(this.gl.VERTEX_SHADER),this.gl.shaderSource(this.vertShader,v),this.gl.compileShader(this.vertShader),!this.gl.getShaderParameter(this.vertShader,this.gl.COMPILE_STATUS)){let t=1;const e=this.vertShader;console.warn((t+"	|"+this.gl.getShaderSource(e)).replace(/\n/g,()=>`
${++t}	|`)),console.error(new Error(`VertShaderError: 
	${this.gl.getShaderInfoLog(this.vertShader)}
`))}}initFragShader(t){const e=this.programStore[t];e.fragShader&&this.gl.deleteShader(e.fragShader),e.fragShader=this.gl.createShader(this.gl.FRAGMENT_SHADER);const r=this.initFragCode(e);if(this.gl.shaderSource(e.fragShader,r),this.gl.compileShader(e.fragShader),!this.gl.getShaderParameter(e.fragShader,this.gl.COMPILE_STATUS)){let n=1;const i=e.fragShader;console.warn((n+"	|"+this.gl.getShaderSource(i)).replace(/\n/g,()=>`
${++n}	|`)),console.error(Error(`fragShaderError(${t}): 
...
`});let n="";return this.EXT_DERIVATIVES&&(n+=`#ifdef GL_OES_standard_derivatives
