import{am as O,r as x,c,aw as j,ax as M,ay as B,a4 as r,V as N,v,x as m,B as P,D as w,H as W,L as $,M as s,W as e,z as q,q as G}from"./chunks/framework.C7hFoqOj.js";import{O as K,u as U}from"./chunks/theme.BwFCI582.js";const E=`// precision highp float;
...
`);return(o,n)=>{const a=r("gl-float"),i=r("gl-mat4"),l=r("gl-image"),f=r("gl-program"),z=r("gl-canvas"),A=N("tooltip");return v(),m("div",R,[p.value?W("",!0):P((v(),m("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:n[0]||(n[0]=Q=>{w(h)(),p.value=!0})},H)),[[A,"Enable audio input"]]),(v(),$(z,{onUpdate:S,key:w(F)},{default:s(()=>[e(f,{name:"buffer0",code:b.value},{default:s(()=>[e(a,{name:"u_light",value:u.value},null,8,["value"]),e(i,{name:"u_notes",value:y.value},null,8,["value"]),e(l,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),e(f,{name:"buffer1",code:b.value},{default:s(()=>[e(a,{name:"u_light",value:u.value},null,8,["value"]),e(i,{name:"u_notes",value:y.value},null,8,["value"]),e(l,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),e(f,{name:"main",code:T.value},{default:s(()=>[e(l,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}},ee=JSON.parse('{"title":"GPU shader with feedback","description":"More interesting and chaotic shader setup","frontmatter":{"title":"GPU shader with feedback","description":"More interesting and chaotic shader setup","date":"2021-04-22T00:00:00.000Z","cover":"feedback.png","layout":"app"},"headers":[],"relativePath":"practice/chroma/shader/feedback/index.md","filePath":"practice/chroma/shader/feedback/index.md","lastUpdated":1719137967000}'),J={name:"practice/chroma/shader/feedback/index.md"};function Z(C,d,h,g,_,u){const p=I,t=r("client-only");return v(),m("div",null,[e(t,null,{default:s(()=>[e(p,{class:"min-h-70svh h-80svh"})]),_:1})])}const ne=G(J,[["render",Z]]);export{ee as __pageData,ne as default};
