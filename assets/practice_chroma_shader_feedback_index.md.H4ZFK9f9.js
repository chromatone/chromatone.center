import{am as O,r as x,c,aw as j,ax as M,ay as B,a5 as r,Y as N,v,x as m,B as P,D as w,H as $,L as q,M as s,a0 as e,z as G,q as K}from"./chunks/framework.BnmkQ2kF.js";import{H as U,u as W}from"./chunks/theme.u_z9G0Y0.js";const E=`// precision highp float;
...
`);return(o,n)=>{const a=r("gl-float"),i=r("gl-mat4"),l=r("gl-image"),f=r("gl-program"),z=r("gl-canvas"),A=N("tooltip");return v(),m("div",R,[p.value?$("",!0):P((v(),m("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:n[0]||(n[0]=Z=>{w(h)(),p.value=!0})},H)),[[A,"Enable audio input"]]),(v(),q(z,{onUpdate:S,key:w(F)},{default:s(()=>[e(f,{name:"buffer0",code:b.value},{default:s(()=>[e(a,{name:"u_light",value:u.value},null,8,["value"]),e(i,{name:"u_notes",value:y.value},null,8,["value"]),e(l,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),e(f,{name:"buffer1",code:b.value},{default:s(()=>[e(a,{name:"u_light",value:u.value},null,8,["value"]),e(i,{name:"u_notes",value:y.value},null,8,["value"]),e(l,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),e(f,{name:"main",code:T.value},{default:s(()=>[e(l,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}},ee=JSON.parse('{"title":"GPU shader with feedback","description":"More interesting and chaotic shader setup","frontmatter":{"title":"GPU shader with feedback","description":"More interesting and chaotic shader setup","date":"2021-04-22T00:00:00.000Z","cover":"feedback.png","layout":"app"},"headers":[],"relativePath":"practice/chroma/shader/feedback/index.md","filePath":"practice/chroma/shader/feedback/index.md","lastUpdated":1719911957000}'),J={name:"practice/chroma/shader/feedback/index.md"};function Y(C,d,h,g,_,u){const p=I,t=r("client-only");return v(),m("div",null,[e(t,null,{default:s(()=>[e(p,{class:"min-h-70svh h-80svh"})]),_:1})])}const ne=K(J,[["render",Y]]);export{ee as __pageData,ne as default};
