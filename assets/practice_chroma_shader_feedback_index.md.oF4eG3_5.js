import{am as O,r as x,c,at as j,au as M,av as N,a4 as r,M as B,E as v,F as m,N as G,C,T as P,a2 as $,X as s,O as e,G as E,D as K}from"./chunks/framework.BtWLkna7.js";import{O as U,u as W}from"./chunks/theme.CxCdgvPq.js";const q=`// precision highp float;
...
}`,R={class:"relative rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},V=E("div",{class:"i-la-microphone"},null,-1),I=[V],J={__name:"GpuFeedback",setup(w){const{tuner:d,init:h}=U(),{width:g,height:_}=O(),u=x(0),p=x(!1),{midi:t}=W(),b=c(()=>q),D=c(()=>{let o=new Array(12).fill(0);for(let n in t==null?void 0:t.activeNotes){const a=(Number(n)-9)%12;o[a]+=t==null?void 0:t.activeNotes[n]}return o.map((n,a)=>{let i=Math.pow(d.aChroma[a],2),l=i>Math.pow(d.chromaAvg,2)&&!d.note.silent?i:0;return n+l})}),k=j(D,{duration:200,transition:M.easeOutExpo}),y=c(()=>{const o=Array(16).fill(0);return k.value.forEach((n,a)=>o[a]=n),o});function S(o){u.value=(Math.sin(o.iTime)+1)/2}const L=c(()=>g.value||_.value?Math.random():0),F=N(L,100),T=c(()=>`
...
`);return(o,n)=>{const a=r("gl-float"),i=r("gl-mat4"),l=r("gl-image"),f=r("gl-program"),z=r("gl-canvas"),A=B("tooltip");return v(),m("div",R,[p.value?P("",!0):G((v(),m("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:n[0]||(n[0]=H=>{C(h)(),p.value=!0})},I)),[[A,"Enable audio input"]]),(v(),$(z,{onUpdate:S,key:C(F)},{default:s(()=>[e(f,{name:"buffer0",code:b.value},{default:s(()=>[e(a,{name:"u_light",value:u.value},null,8,["value"]),e(i,{name:"u_notes",value:y.value},null,8,["value"]),e(l,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"]),e(f,{name:"buffer1",code:b.value},{default:s(()=>[e(a,{name:"u_light",value:u.value},null,8,["value"]),e(i,{name:"u_notes",value:y.value},null,8,["value"]),e(l,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"]),e(f,{name:"main",code:T.value},{default:s(()=>[e(l,{name:"u_mainOutput",value:"buffer1"})]),_:1},8,["code"])]),_:1}))])}}},ee=JSON.parse('{"title":"GPU shader with feedback","description":"More interesting and chaotic shader setup","frontmatter":{"title":"GPU shader with feedback","description":"More interesting and chaotic shader setup","date":"2021-04-22T00:00:00.000Z","cover":"feedback.png","layout":"app"},"headers":[],"relativePath":"practice/chroma/shader/feedback/index.md","filePath":"practice/chroma/shader/feedback/index.md","lastUpdated":1712226286000}'),X={name:"practice/chroma/shader/feedback/index.md"};function Z(w,d,h,g,_,u){const p=J,t=r("client-only");return v(),m("div",null,[e(t,null,{default:s(()=>[e(p,{class:"min-h-70svh h-80svh"})]),_:1})])}const ne=K(X,[["render",Z]]);export{ee as __pageData,ne as default};
