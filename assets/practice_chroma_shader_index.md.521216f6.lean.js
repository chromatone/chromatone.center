import{U as j,z as _,b as l,V as F,W as G,X as W,K as a,C as N,o as s,c as m,D as P,u as b,q,g as K,w as p,f as i,a as M,_ as U}from"./chunks/framework.a2b37741.js";import{u as $}from"./chunks/midi.743c5d70.js";import{u as B}from"./chunks/tuner.659f69cd.js";import"./chunks/audio.e867938e.js";import"./chunks/colors.238ec2c1.js";import"./chunks/loop.d0a8c12d.js";import"./chunks/mic.4b618615.js";import"./chunks/Midi.1f918097.js";import"./chunks/tempo.41bb4de7.js";import"./chunks/noise.be049ee9.js";import"./chunks/index.6a7bc922.js";import"./chunks/sequence.2d94d1ea.js";import"./chunks/synth.9bc7f4cd.js";import"./chunks/theory.61e5aadb.js";import"./chunks/commonjsHelpers.de833af9.js";import"./chunks/index.b30cd6d2.js";import"./chunks/calculations.65ee336d.js";import"./chunks/index.654bd828.js";import"./chunks/index.f74fb029.js";import"./chunks/midiRender.b18e39bb.js";import"./chunks/Sequence.350cbae4.js";import"./chunks/Loop.453a3dc4.js";import"./chunks/UserMedia.2ff38ecd.js";import"./chunks/Subtract.35ba69ab.js";import"./chunks/OnePoleFilter.cf2fc2e6.js";import"./chunks/FFT.833fe475.js";import"./chunks/BitCrusher.f249de92.js";import"./chunks/Filter.ce4e91cc.js";import"./chunks/AutoPanner.9b342708.js";import"./chunks/Scale.0b96c1a3.js";import"./chunks/PingPongDelay.b7a6be12.js";import"./chunks/MonoSynth.32fcb411.js";import"./chunks/index.86652af6.js";const I=`// precision highp float;
...
}`,V={class:"relative min-h-70svh h-80svh rounded-lg overflow-hidden pointer-events-auto touch-revert",id:"screen"},E=M("div",{class:"i-la-microphone"},null,-1),R=[E],J={__name:"GpuShader",setup(x){const{tuner:r,init:u}=B(),{width:f,height:h}=j(),d=_(0),c=_(!1),{midi:n}=$(),w=l(()=>I),C=l(()=>{let t=new Array(12).fill(0);for(let e in n==null?void 0:n.activeNotes){const o=(Number(e)-9)%12;t[o]+=n==null?void 0:n.activeNotes[e]}return t.map((e,o)=>{let v=r.aChroma[o]>r.chromaAvg&&!r.note.silent?r.aChroma[o]:0;return e+v})}),S=F(C,{duration:200,transition:G.easeOutExpo}),D=l(()=>{const t=Array(16).fill(0);return S.value.forEach((e,o)=>t[o]=e),t});function L(t){d.value=(Math.sin(t.iTime)+1)/2}const z=l(()=>f.value||h.value?Math.random():0),T=W(z,100),k=l(()=>`
...
`);return(t,e)=>{const o=a("gl-float"),v=a("gl-mat4"),g=a("gl-image"),y=a("gl-program"),A=a("gl-canvas"),O=N("tooltip");return s(),m("div",V,[c.value?q("",!0):P((s(),m("button",{key:0,class:"absolute z-200 text-2xl top-2 right-2 opacity-30 hover-opacity-100 transition",onClick:e[0]||(e[0]=H=>{b(u)(),c.value=!0})},R)),[[O,"Enable audio input"]]),(s(),K(A,{onUpdate:L,key:b(T)},{default:p(()=>[i(y,{name:"buffer0",code:w.value},{default:p(()=>[i(o,{name:"u_light",value:d.value},null,8,["value"]),i(v,{name:"u_notes",value:D.value},null,8,["value"]),i(g,{name:"u_mainOutput",value:"feedbackProgram"})]),_:1},8,["code"]),i(y,{name:"main",code:k.value},{default:p(()=>[i(g,{name:"u_mainOutput",value:"buffer0"})]),_:1},8,["code"])]),_:1}))])}}},Oe=JSON.parse('{"title":"GPU shader","description":"A MIDI reactive GLSL shader as a direct visual mathematical interpretation of musical notes","frontmatter":{"title":"GPU shader","description":"A MIDI reactive GLSL shader as a direct visual mathematical interpretation of musical notes","date":"2021-04-22T00:00:00.000Z","links":["https://github.com/kongxiaojian123/vue-glsl#readme","https://registry.khronos.org/OpenGL-Refpages/gl4/index.php","https://iquilezles.org/articles/palettes/","https://thebookofshaders.com/","https://github.com/jamieowen/glsl-blend","https://www.shadertoy.com/view/4tSGWV","https://www.shadertoy.com/view/mtyGWy"]},"headers":[],"relativePath":"practice/chroma/shader/index.md","filePath":"practice/chroma/shader/index.md","lastUpdated":1694022443000}'),X={name:"practice/chroma/shader/index.md"};function Z(x,r,u,f,h,d){const c=J,n=a("client-only");return s(),m("div",null,[i(n,null,{default:p(()=>[i(c)]),_:1})])}const je=U(X,[["render",Z]]);export{Oe as __pageData,je as default};
