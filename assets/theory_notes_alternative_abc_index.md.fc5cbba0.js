import{_ as f}from"./chunks/youtube-embed.8d06380f.js";import{C as h,H as u,ac as _,o as A,c as o,a as e,F as p,r as g,t as G,u as r,L as C,aF as m,a8 as b,_ as V,E as F,e as i,G as v,k as w,b as D}from"./app.83d10e71.js";var c={"Four octaves":`
  X:1
T:Notes
M:C
L:1/4
...
V:2
A,,E,A, z z2|z6|A,,E,A, z z2|E,,E,^G, z z2|[A,,,4A,,4]|]`};const y={class:"flex flex-col m-auto max-w-65ch"},k={class:"flex flex-wrap"},x=["onClick"],T=e("div",{id:"warnings"},null,-1),L=e("div",{class:"mt-6",id:"audio"},null,-1),P=e("div",{id:"paper"},null,-1),W={name:"editor",setup(l){const t=h("abc-notes",c.kalinka);return u(()=>{_(()=>import("./chunks/index.1b23e174.js").then(function(a){return a.i}),[]).then(a=>{new a.Editor("abc",{canvas_id:"paper",warnings_id:"warnings",synth:{el:"#audio",options:{displayLoop:!0,displayRestart:!0,displayPlay:!0,displayProgress:!0,displayWarp:!0}},abcjsParams:{}})})}),(a,d)=>(A(),o("div",y,[e("div",k,[(A(!0),o(p,null,g(r(c),(n,s)=>(A(),o("button",{class:"p-2 border-1 m-2",key:s,onClick:z=>t.value=n},G(s),9,x))),128))]),C(e("textarea",{class:"w-full",id:"abc","onUpdate:modelValue":d[0]||(d[0]=n=>b(t)?t.value=n:null),rows:"18"},null,512),[[m,r(t)]]),T,L,P]))}},R='{"title":"ABC notation","description":"","frontmatter":{"title":"ABC notation","subtitle":"A shorthand form of musical notation for computers","date":"2021-09-15T00:00:00.000Z"},"headers":[],"relativePath":"theory/notes/alternative/abc/index.md"}',K={},I=e("p",null,[e("a",{href:"https://abcnotation.com/wiki/abc:standard:v2.1",class:"external-link",target:"_blank",rel:"noopener noreferrer"},"ABC notation"),w(" is a shorthand form of musical notation for computers. In basic form it uses the letter notation with a\u2013g, A\u2013G, and z, to represent the corresponding notes and rests, with other elements used to place added value on these \u2013 sharp, flat, raised or lowered octave, the note length, key, and ornamentation. This form of notation began from a combination of Helmholtz pitch notation and using ASCII characters to imitate standard musical notation (bar lines, tempo marks, etc.) that could facilitate the sharing of music online, and also added a new and simple language for software developers, not unlike other notations designed for ease, such as tablature and solf\xE8ge.")],-1),M=D('<p><a href="https://abcnotation.com/browseTunes" class="external-link" target="_blank" rel="noopener noreferrer">Browse tunes</a></p><p>The earlier ABC notation was built on, standardized, and changed by Chris Walshaw to better fit the keyboard and an ASCII character set, with the help and input of others. Originally designed to encode folk and traditional Western European tunes (e.g., from England, Ireland, and Scotland) which are typically single-voice melodies that can be written in standard notation on a single staff line, the extensions by Walshaw and others has opened this up with an increased list of characters and headers in a syntax that can also support metadata for each tune:</p><ul><li>The index, when there are more than one tune in a file (X:)- the title (T:),</li><li>the time signature (M:),</li><li>the default note length (L:),</li><li>the type of tune (R:),</li><li>the key (K:) <ul><li>with the clef (K: clef=[treble|alto|tenor|bass|perc])</li></ul></li></ul><p>Lines following the key designation represent the tune.</p><p>After a surge of renewed interest in clarifying some ambiguities in the 2.0 draft and suggestions for new features, serious discussion of a new (and official) standard resumed in 2011, culminating in the release of ABC 2.1 as a new standard in late December 2011. Chris Walshaw has become involved again and is coordinating the effort to further improve and clarify the language, with plans for topics to be addressed in future versions to be known as ABC 2.2 and ABC 2.3 .</p>',5),N=e("p",null,[e("a",{href:"https://abcnotation.com/learn",class:"external-link",target:"_blank",rel:"noopener noreferrer"},"https://abcnotation.com/learn")],-1);function S(l,t,a,d,n,s){const z=W,E=F("client-only"),B=f;return A(),o("div",null,[I,i(E,null,{default:v(()=>[i(z)]),_:1}),M,i(B,{video:"H8hWKP5cEXE"}),N])}var O=V(K,[["render",S]]);export{R as __pageData,O as default};
