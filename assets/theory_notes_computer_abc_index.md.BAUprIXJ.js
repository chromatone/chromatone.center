const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.Bdn_y4tX.js","assets/chunks/theme.DfZDddzd.js","assets/chunks/framework.CSNlL4yK.js"])))=>i.map(i=>d[i]);
import{u as g,aM as C,n as E,a as _,aI as G}from"./chunks/theme.DfZDddzd.js";import{o as b,a0 as V,q as c,f as z,l,s as t,Z as w,F,Y as v,z as D,u as B,a4 as k,C as y,_ as x,i as T,ad as L,aw as f,j as M}from"./chunks/framework.CSNlL4yK.js";import{_ as S}from"./chunks/SaveSvg.BFMi_k0g.js";import{s as u}from"./chunks/state.C-nynwFu.js";const h={"Four octaves":`
  X:1
T:Notes
M:C
L:1/4
...
V:2
A,,E,A, z z2|z6|A,,E,A, z z2|E,,E,^G, z z2|[A,,,4A,,4]|]`},I={class:"flex flex-col m-auto"},P={class:"flex flex-wrap"},K=["onClick"],N={__name:"AbcEditor",setup(p){const e=g("abc-notes",h.kalinka);return b(()=>{V(()=>import("./chunks/index.Bdn_y4tX.js").then(d=>d.i),__vite__mapDeps([0,1,2])).then(d=>{new d.Editor("abc",{canvas_id:"paper",warnings_id:"warnings",synth:{el:"#audio",cursorControl:{beatSubDivision:4},options:{}},abcjsParams:{staffwidth:200}})}),C([e,u],d=>{document.querySelectorAll("[data-name]").forEach(A=>{if(A instanceof HTMLElement)if(u.colorize){const a={pitch:0,acc:0,octave:4},{name:n}=A.dataset;if(n.length>3||/^\d+$/.test(n)||n=="bar")return;for(let s=0;s<n.length;s++)switch(E.findIndex(i=>i==n[s]?.toUpperCase()),n[s]){case"^":a.acc++;break;case"_":a.acc--;break;case",":a.octave--;break;default:const i=E.findIndex(m=>m==n[s]?.toUpperCase());if(i<0)break;n[s]==E[i].toLowerCase()&&a.octave++,a.pitch=i,A.dataset.pitch=String(i);break}const r=(a.pitch+a.acc+12)%12;A.style.fill=_(r,a.octave)}else A.style.fill="currentColor"})},{immediate:!0})}),(d,o)=>{const A=S;return z(),c("div",I,[l(A,{class:"fixed bottom-4 right-55",svg:"paper",deep:!0}),t("div",P,[(z(!0),c(F,null,v(B(h),(a,n)=>(z(),c("button",{class:"p-2 border-1 m-2",key:n,onClick:r=>e.value=a},D(n),9,K))),128))]),w(t("textarea",{class:"w-full dark-bg-dark-800 p-4",id:"abc","onUpdate:modelValue":o[0]||(o[0]=a=>y(e)?e.value=a:null),rows:"18"},null,512),[[k,B(e)]]),o[1]||(o[1]=t("div",{id:"warnings"},null,-1)),o[2]||(o[2]=t("div",{class:"mt-6",id:"audio"},null,-1)),o[3]||(o[3]=t("div",{id:"paper"},null,-1))])}}},U=JSON.parse('{"title":"ABC notation","description":"A shorthand form of musical notation for computers","frontmatter":{"title":"ABC notation","description":"A shorthand form of musical notation for computers","date":"2021-09-15T00:00:00.000Z"},"headers":[],"relativePath":"theory/notes/computer/abc/index.md","filePath":"theory/notes/computer/abc/index.md","lastUpdated":1788869361000}'),W={name:"theory/notes/computer/abc/index.md"};function $(p,e,d,o,A,a){const n=N,r=T("client-only"),s=G;return z(),c("div",null,[e[0]||(e[0]=t("p",null,[t("a",{href:"https://abcnotation.com/wiki/abc:standard:v2.1",target:"_blank",rel:"noreferrer"},"ABC notation"),f(" is a shorthand form of musical notation for computers. In basic form it uses the letter notation with a–g, A–G, and z, to represent the corresponding notes and rests, with other elements used to place added value on these – sharp, flat, raised or lowered octave, the note length, key, and ornamentation. This form of notation began from a combination of Helmholtz pitch notation and using ASCII characters to imitate standard musical notation (bar lines, tempo marks, etc.) that could facilitate the sharing of music online, and also added a new and simple language for software developers, not unlike other notations designed for ease, such as tablature and solfège.")],-1)),l(r,null,{default:M(()=>[l(n)]),_:1}),e[1]||(e[1]=L('<p><a href="https://abcnotation.com/browseTunes" target="_blank" rel="noreferrer">Browse tunes</a></p><p>The earlier ABC notation was built on, standardized, and changed by Chris Walshaw to better fit the keyboard and an ASCII character set, with the help and input of others. Originally designed to encode folk and traditional Western European tunes (e.g., from England, Ireland, and Scotland) which are typically single-voice melodies that can be written in standard notation on a single staff line, the extensions by Walshaw and others has opened this up with an increased list of characters and headers in a syntax that can also support metadata for each tune:</p><ul><li>The index, when there are more than one tune in a file (X:)- the title (T:),</li><li>the time signature (M:),</li><li>the default note length (L:),</li><li>the type of tune (R:),</li><li>the key (K:) <ul><li>with the clef (K: clef=[treble|alto|tenor|bass|perc])</li></ul></li></ul><p>Lines following the key designation represent the tune.</p><p>After a surge of renewed interest in clarifying some ambiguities in the 2.0 draft and suggestions for new features, serious discussion of a new (and official) standard resumed in 2011, culminating in the release of ABC 2.1 as a new standard in late December 2011. Chris Walshaw has become involved again and is coordinating the effort to further improve and clarify the language, with plans for topics to be addressed in future versions to be known as ABC 2.2 and ABC 2.3 .</p>',5)),l(s,{video:"H8hWKP5cEXE"}),e[2]||(e[2]=t("h2",{id:"more-links",tabindex:"-1"},[f("More links "),t("a",{class:"header-anchor",href:"#more-links","aria-label":"Permalink to “More links”"},"​")],-1)),e[3]||(e[3]=t("ul",null,[t("li",null,[t("a",{href:"https://abcnotation.com/learn",target:"_blank",rel:"noreferrer"},"https://abcnotation.com/learn")]),t("li",null,[t("a",{href:"https://www.abcjs.net/",target:"_blank",rel:"noreferrer"},"https://www.abcjs.net/")])],-1))])}const H=x(W,[["render",$]]);export{U as __pageData,H as default};
