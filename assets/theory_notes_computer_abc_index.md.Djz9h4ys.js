const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/abcjs.A8AAvaAI.js","assets/chunks/rolldown-runtime.C0FnF6B9.js"])))=>i.map(i=>d[i]);
import{o as e}from"./chunks/rolldown-runtime.C0FnF6B9.js";import{A as t,At as n,E as r,F as i,I as a,L as o,M as s,Pt as c,R as l,Z as u,_t as d,at as f,dt as p,et as m,ft as h,n as g,rt as _,t as v}from"./chunks/framework.Bs4wm_X5.js";import{Nn as y,Un as b,d as x,gt as S,ut as C}from"./chunks/theme.BWy_r1Ty.js";import{t as w}from"./chunks/SaveSvg.B7shzK4r.js";import{t as T}from"./chunks/state.BPZbzUdf.js";var E={"Four octaves":`
  X:1
T:Notes
M:C
L:1/4
...
V:2
A,,E,A, z z2|z6|A,,E,A, z z2|E,,E,^G, z z2|[A,,,4A,,4]|]`},D={class:`flex flex-col m-auto`},O={class:`flex flex-wrap`},k=[`onClick`],A={__name:`AbcEditor`,setup(a){let o=y(`abc-notes`,E.kalinka);return u(()=>{v(()=>import(`./chunks/abcjs.A8AAvaAI.js`).then(t=>e(t.default)).then(e=>{new e.Editor(`abc`,{canvas_id:`paper`,warnings_id:`warnings`,synth:{el:`#audio`,cursorControl:{beatSubDivision:4},options:{}},abcjsParams:{staffwidth:200}})}),__vite__mapDeps([0,1])),b([o,T],e=>{document.querySelectorAll(`[data-name]`).forEach(e=>{if(e instanceof HTMLElement){if(T.colorize){let t={pitch:0,acc:0,octave:4},{name:n}=e.dataset;if(n.length>3||/^\d+$/.test(n)||n==`bar`)return;for(let r=0;r<n.length;r++)switch(S.findIndex(e=>e==n[r]?.toUpperCase()),n[r]){case`^`:t.acc++;break;case`_`:t.acc--;break;case`,`:t.octave--;break;default:let i=S.findIndex(e=>e==n[r]?.toUpperCase());if(i<0)break;n[r]==S[i].toLowerCase()&&t.octave++,t.pitch=i,e.dataset.pitch=String(i)}let r=(t.pitch+t.acc+12)%12;e.style.fill=C(r,t.octave)}else e.style.fill=`currentColor`}})},{immediate:!0})}),(e,a)=>{let u=w;return m(),i(`div`,D,[l(u,{class:`fixed bottom-4 right-55`,svg:`paper`,deep:!0}),s(`div`,O,[(m(!0),i(t,null,_(n(E),(e,t)=>(m(),i(`button`,{class:`p-2 border-1 m-2`,key:t,onClick:t=>o.value=e},c(t),9,k))),128))]),h(s(`textarea`,{class:`w-full dark-bg-dark-800 p-4`,id:`abc`,"onUpdate:modelValue":a[0]||=e=>d(o)?o.value=e:null,rows:`18`},null,512),[[r,n(o)]]),a[1]||=s(`div`,{id:`warnings`},null,-1),a[2]||=s(`div`,{class:`mt-6`,id:`audio`},null,-1),a[3]||=s(`div`,{id:`paper`},null,-1)])}}},j=JSON.parse(`{"title":"ABC notation","description":"A shorthand form of musical notation for computers","frontmatter":{"title":"ABC notation","description":"A shorthand form of musical notation for computers","date":"2021-09-15T00:00:00.000Z"},"headers":[],"relativePath":"theory/notes/computer/abc/index.md","filePath":"theory/notes/computer/abc/index.md","lastUpdated":1789463788000}`),M={name:`theory/notes/computer/abc/index.md`};function N(e,t,n,r,c,u){let d=A,h=f(`client-only`),g=x;return m(),i(`div`,null,[t[0]||=s(`p`,null,[s(`a`,{href:`https://abcnotation.com/wiki/abc:standard:v2.1`,target:`_blank`,rel:`noreferrer`},`ABC notation`),o(` is a shorthand form of musical notation for computers. In basic form it uses the letter notation with a–g, A–G, and z, to represent the corresponding notes and rests, with other elements used to place added value on these – sharp, flat, raised or lowered octave, the note length, key, and ornamentation. This form of notation began from a combination of Helmholtz pitch notation and using ASCII characters to imitate standard musical notation (bar lines, tempo marks, etc.) that could facilitate the sharing of music online, and also added a new and simple language for software developers, not unlike other notations designed for ease, such as tablature and solfège.`)],-1),l(h,null,{default:p(()=>[l(d)]),_:1}),t[1]||=a(`<p><a href="https://abcnotation.com/browseTunes" target="_blank" rel="noreferrer">Browse tunes</a></p><p>The earlier ABC notation was built on, standardized, and changed by Chris Walshaw to better fit the keyboard and an ASCII character set, with the help and input of others. Originally designed to encode folk and traditional Western European tunes (e.g., from England, Ireland, and Scotland) which are typically single-voice melodies that can be written in standard notation on a single staff line, the extensions by Walshaw and others has opened this up with an increased list of characters and headers in a syntax that can also support metadata for each tune:</p><ul><li>The index, when there are more than one tune in a file (X:)- the title (T:),</li><li>the time signature (M:),</li><li>the default note length (L:),</li><li>the type of tune (R:),</li><li>the key (K:) <ul><li>with the clef (K: clef=[treble|alto|tenor|bass|perc])</li></ul></li></ul><p>Lines following the key designation represent the tune.</p><p>After a surge of renewed interest in clarifying some ambiguities in the 2.0 draft and suggestions for new features, serious discussion of a new (and official) standard resumed in 2011, culminating in the release of ABC 2.1 as a new standard in late December 2011. Chris Walshaw has become involved again and is coordinating the effort to further improve and clarify the language, with plans for topics to be addressed in future versions to be known as ABC 2.2 and ABC 2.3 .</p>`,5),l(g,{video:`H8hWKP5cEXE`}),t[2]||=s(`h2`,{id:`more-links`,tabindex:`-1`},[o(`More links `),s(`a`,{class:`header-anchor`,href:`#more-links`,"aria-label":`Permalink to “More links”`},`​`)],-1),t[3]||=s(`ul`,null,[s(`li`,null,[s(`a`,{href:`https://abcnotation.com/learn`,target:`_blank`,rel:`noreferrer`},`https://abcnotation.com/learn`)]),s(`li`,null,[s(`a`,{href:`https://www.abcjs.net/`,target:`_blank`,rel:`noreferrer`},`https://www.abcjs.net/`)])],-1)])}var P=g(M,[[`render`,N]]);export{j as __pageData,P as default};