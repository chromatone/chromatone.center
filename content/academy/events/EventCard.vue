...
<template lang='pug'>
a.overflow-hidden.flex.flex-wrap.shadow-lg.hover-shadow-xl.transition.flex-1.dark-bg-dark-300.max-w-150( :href="`/academy/events/${slug}.html`" style="padding-bottom:0;padding-left:0; padding-right:0; flex: 1 1 auto" )
