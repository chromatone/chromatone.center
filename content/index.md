...
We've discovered complete and coherent Visual Music Language there. It's evolving through further merging colors with notes, rhythms with shapes, intervals with gradients, chords and scales with palettes. And we pave the way for new generations of visual music explorers and performers.

We're creating the Visual Music [Theory](./theory/index.md) study, that helps beginners learn complex music concepts with colors and shapes. Interactive web-apps in the [Practice](./practice/index.md) section expand the knowledge and grow deeper music awareness. Those, who want to go beyond personal explorations and get guided educational programs and community learning experience, can request personal [Tutorship](/tutor/) guidance by the author himself. For those who want to see the colors off-screen and touch the colorful notes directly with fingers - we have a cozy [Sticker Shop](./shop/index.md) to roam around.

If you have any questions or ideas to share - feel free to [contact us](contacts/index.md) anytime.
