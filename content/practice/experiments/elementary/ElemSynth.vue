...
.flex.flex-col.gap-2.is-group.p-2
  .flex.flex-col.relative.mb-3
    OscilloScope.absolute.-top-5(name="synth")
    .flex.flex-wrap.gap-1.font-mono.w-full.h-10
      .text-xs.flex.flex-1.text-center.rounded-xl.justify-center.font-bold.items-center(
