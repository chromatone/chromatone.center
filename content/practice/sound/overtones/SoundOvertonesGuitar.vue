...
<template lang="pug">
// Rotated 180 degrees around the center of the fretboard
g#guitar(:transform="`translate(${length * 0.351}, 6) rotate(180) translate(-${length * 0.351}, -6)`")
  path#body(
  ...
  line(
    ...
    :key="fret"
    :x1="fret * length * 0.702"
    :x2="fret * length * 0.702"
    y1="0"
    y2="12"
    stroke="currentColor"
    stroke-width="0.2"
