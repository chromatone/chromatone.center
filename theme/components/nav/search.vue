...
.flex.items-center.flex-col.w-full
  .flex.items-center.w-full
    input.w-full.p-2.rounded-xl.z-20.bg-light-100.dark-bg-dark-100.shadow(
      ref="inputEl"
      v-model="input" 
      placeholder="Start typing..."
      )
    button.absolute.right-6.z-400(v-if="input" @click="input =''")
      .i-la-times.text-lg
  .flex.flex-col.max-h-80vh.overflow-y-scroll.shadow-lg.mt-2.rounded-lg.z-2000.top-10
