...
<template lang="pug">
.p-4.ml-10.mr-16.flex.flex-col.gap-2.bg_light-100.bg-light-200.dark-bg-dark-200.bg-opacity-85.dark-bg-opacity-85.hover-opacity-100.transition.right-16.z-10.max-w-57ch.rounded-lg.backdrop-blur-md.shadow-lg(
